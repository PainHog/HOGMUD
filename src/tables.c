...
SPELL_FUN *spell_function( char *name )
{
	...
	if ( !str_cmp( name, "spell_disenchant_equipment"))	return spell_disenchant_equipment;
    ...
    if ( !str_cmp( name, "spell_dispel_neutral" ))   return spell_dispel_neutral;
	if ( !str_cmp( name, "spell_draining_weapon" ))	 return spell_draining_weapon;
    ...
    if ( !str_cmp( name, "spell_fear" ))	     return spell_fear;
    if ( !str_cmp( name, "spell_fireball" ))	     return spell_fireball;
    if ( !str_cmp( name, "spell_flamestrike" ))	     return spell_flamestrike;
    if ( !str_cmp( name, "spell_freezing_weapon" ))  return spell_freezing_weapon;
    if ( !str_cmp( name, "spell_gate" ))	     return spell_gate;
    if ( !str_cmp( name, "spell_demonic_beast" ))    return spell_demonic_beast;
    if ( !str_cmp( name, "spell_daemon_guardian" ))  return spell_daemon_guardian;
    if ( !str_cmp( name, "spell_summon_golem" ))     return spell_summon_golem;
    if ( !str_cmp( name, "spell_conjurers_sword" ))  return spell_conjurers_sword;
    if ( !str_cmp( name, "spell_golem_plate" ))	     return spell_golem_plate;
    if ( !str_cmp( name, "spell_golem_fists" ))	     return spell_golem_fists;
    if ( !str_cmp( name, "spell_golem_cloak" ))      return spell_golem_cloak;
    if ( !str_cmp( name, "spell_golem_shield" ))     return spell_golem_shield;
    if ( !str_cmp( name, "spell_golem_weapon" ))     return spell_golem_weapon;
    if ( !str_cmp( name, "spell_alchemy_shield" ))  return spell_alchemy_shield;
    if ( !str_cmp( name, "spell_alchemy_armor" ))        return spell_alchemy_armor;
    if ( !str_cmp( name, "spell_alchemy_light" ))        return spell_alchemy_light;
    if ( !str_cmp( name, "spell_alchemy_bless" ))        return spell_alchemy_bless;
    if ( !str_cmp( name, "spell_alchemy_refresh" ))        return spell_alchemy_refresh;
    if ( !str_cmp( name, "spell_alchemy_fly" ))        return spell_alchemy_fly;
    if ( !str_cmp( name, "spell_alchemy_waterbreath" ))        return spell_alchemy_waterbreath;
    if ( !str_cmp( name, "spell_alchemy_serious" ))        return spell_alchemy_serious;
    if ( !str_cmp( name, "spell_alchemy_poison" ))        return spell_alchemy_poison;
    if ( !str_cmp( name, "spell_alchemy_blindness" ))        return spell_alchemy_blindness;
    if ( !str_cmp( name, "spell_alchemy_curse" ))        return spell_alchemy_curse;
    if ( !str_cmp( name, "spell_alchemy_protect" ))        return spell_alchemy_protect;
    if ( !str_cmp( name, "spell_alchemy_balance" ))        return spell_alchemy_balance;
    if ( !str_cmp( name, "spell_alchemy_corrupt" ))        return spell_alchemy_corrupt;
    if ( !str_cmp( name, "spell_alchemy_level" ))        return spell_alchemy_level;
    if ( !str_cmp( name, "spell_alchemy_critical" ))        return spell_alchemy_critical;
    if ( !str_cmp( name, "spell_alchemy_piercebane" ))        return spell_alchemy_piercebane;
    if ( !str_cmp( name, "spell_alchemy_slashbane" ))        return spell_alchemy_slashbane;
    if ( !str_cmp( name, "spell_alchemy_eldritch" ))        return spell_alchemy_eldritch;
    if ( !str_cmp( name, "spell_alchemy_unseen" ))        return spell_alchemy_unseen;
    if ( !str_cmp( name, "spell_alchemy_travel" ))        return spell_alchemy_travel;
    if ( !str_cmp( name, "spell_alchemy_sanctuary" ))        return spell_alchemy_sanctuary;
    if ( !str_cmp( name, "spell_alchemy_heal" ))        return spell_alchemy_heal;
    if ( !str_cmp( name, "spell_alchemy_escape" ))        return spell_alchemy_escape;
    if ( !str_cmp( name, "spell_alchemy_stone" ))        return spell_alchemy_stone;
    if ( !str_cmp( name, "spell_alchemy_sight" ))        return spell_alchemy_sight;
    if ( !str_cmp( name, "spell_alchemy_demon" ))        return spell_alchemy_demon;
    if ( !str_cmp( name, "spell_alchemy_shelter" ))        return spell_alchemy_shelter;
    if ( !str_cmp( name, "spell_alchemy_fire" ))        return spell_alchemy_fire;
    if ( !str_cmp( name, "spell_alchemy_ice" ))        return spell_alchemy_ice;
    if ( !str_cmp( name, "spell_alchemy_shock" ))        return spell_alchemy_shock;
    if ( !str_cmp( name, "spell_alchemy_mana" ))        return spell_alchemy_mana;
    if ( !str_cmp( name, "spell_alchemy_divinity" ))        return spell_alchemy_divinity;
    if ( !str_cmp( name, "spell_alchemy_metal" ))        return spell_alchemy_metal;
    if ( !str_cmp( name, "spell_alchemy_panic" ))        return spell_alchemy_panic;
    if ( !str_cmp( name, "spell_alchemy_grace" ))        return spell_alchemy_grace;
    if ( !str_cmp( name, "spell_alchemy_drazuk" ))        return spell_alchemy_drazuk;
    if ( !str_cmp( name, "spell_alchemy_fury" ))        return spell_alchemy_fury;
    if ( !str_cmp( name, "spell_alchemy_ashlyn" ))        return spell_alchemy_ashlyn;
    if ( !str_cmp( name, "spell_alchemy_jaren" ))        return spell_alchemy_jaren;
    if ( !str_cmp( name, "spell_alchemy_cahel" ))        return spell_alchemy_cahel;
    if ( !str_cmp( name, "spell_alchemy_vash" ))        return spell_alchemy_vash;
    if ( !str_cmp( name, "spell_alchemy_paul" ))        return spell_alchemy_paul;
    if ( !str_cmp( name, "spell_alchemy_sebille" ))        return spell_alchemy_sebille;
    if ( !str_cmp( name, "spell_armorsmith_standard" )) return spell_armorsmith_standard;
    if ( !str_cmp( name, "spell_armorsmith_spellward" )) return spell_armorsmith_spellward;
    if ( !str_cmp( name, "spell_armorsmith_spiked" )) return spell_armorsmith_spiked;
    if ( !str_cmp( name, "spell_armorsmith_shield" )) return spell_armorsmith_shield;
    if ( !str_cmp( name, "spell_armorsmith_steel" )) return spell_armorsmith_steel;
    if ( !str_cmp( name, "spell_armorsmith_magestone" )) return spell_armorsmith_magestone;
    if ( !str_cmp( name, "spell_armorsmith_bladed" )) return spell_armorsmith_bladed;
    if ( !str_cmp( name, "spell_armorsmith_dragontear" )) return spell_armorsmith_dragontear;
    if ( !str_cmp( name, "spell_armorsmith_reinforced" )) return spell_armorsmith_reinforced;
    if ( !str_cmp( name, "spell_armorsmith_bloodstone" )) return spell_armorsmith_bloodstone;
    if ( !str_cmp( name, "spell_armorsmith_mirror" )) return spell_armorsmith_mirror;
    if ( !str_cmp( name, "spell_armorsmith_vitality" )) return spell_armorsmith_vitality;
    if ( !str_cmp( name, "spell_armorsmith_barbed" )) return spell_armorsmith_barbed;
    if ( !str_cmp( name, "spell_armorsmith_avatar" )) return spell_armorsmith_avatar;
    if ( !str_cmp( name, "spell_weaponsmith_etch" )) return spell_weaponsmith_etch;
    if ( !str_cmp( name, "spell_weaponsmith_light" )) return spell_weaponsmith_light;
    if ( !str_cmp( name, "spell_weaponsmith_weight" )) return spell_weaponsmith_weight;
    if ( !str_cmp( name, "spell_weaponsmith_guard" )) return spell_weaponsmith_guard;
    if ( !str_cmp( name, "spell_weaponsmith_enhance" )) return spell_weaponsmith_enhance;
    if ( !str_cmp( name, "spell_weaponsmith_curve" )) return spell_weaponsmith_curve;
    if ( !str_cmp( name, "spell_weaponsmith_spellward" )) return spell_weaponsmith_spellward;
    if ( !str_cmp( name, "spell_weaponsmith_loyal" )) return spell_weaponsmith_loyal;
    if ( !str_cmp( name, "spell_weaponsmith_swordbane" )) return spell_weaponsmith_swordbane;
    if ( !str_cmp( name, "spell_weaponsmith_thirst" )) return spell_weaponsmith_thirst;
    if ( !str_cmp( name, "spell_weaponsmith_serpent" )) return spell_weaponsmith_serpent;
    if ( !str_cmp( name, "spell_weaponsmith_etherblade" )) return spell_weaponsmith_etherblade;
    if ( !str_cmp( name, "spell_weaponsmith_etherguard" )) return spell_weaponsmith_etherguard;
    if ( !str_cmp( name, "spell_weaponsmith_dragonslayer" )) return spell_weaponsmith_dragonslayer;
    if ( !str_cmp( name, "spell_weaponsmith_ogreslayer" )) return spell_weaponsmith_ogreslayer;
    if ( !str_cmp( name, "spell_weaponsmith_swordbreaker" )) return spell_weaponsmith_swordbreaker;
    if ( !str_cmp( name, "spell_weaponsmith_serpentkiss" )) return spell_weaponsmith_serpentkiss;
    if ( !str_cmp( name, "spell_weaponsmith_devour" )) return spell_weaponsmith_devour;
    ...
    if ( !str_cmp( name, "spell_imp_invis" ))        return spell_imp_invis;
    if ( !str_cmp( name, "spell_invis" ))	     return spell_invis;
    if ( !str_cmp( name, "spell_invis_object" ))     return spell_invis_object;
    ...
    if ( !str_cmp( name, "spell_mithril_bolt" ))     return spell_mithril_bolt;
    if ( !str_cmp( name, "spell_silver_arrow" ))     return spell_silver_arrow;
    if ( !str_cmp( name, "spell_flaming_blast" ))    return spell_flaming_blast;
    ...
    if ( !str_cmp( name, "spell_natures_companion" )) return spell_natures_companion;
    ...
    if ( !str_cmp( name, "spell_shocking_weapon" ))  return spell_shocking_weapon;
    ...
    if ( !str_cmp( name, "spell_telescape" ))	     return spell_telescape;
    ...
    if ( !str_cmp( name, "spell_astral_rift" ))      return spell_astral_rift;
    ...
    if ( !str_cmp( name, "spell_enchant_treasure" ))    return spell_enchant_treasure;
	if ( !str_cmp( name, "spell_magika_armor" ))		return spell_magika_armor;
	if ( !str_cmp( name, "spell_channel" ))				return spell_channel;
	if ( !str_cmp( name, "spell_ethereal_cloak" ))		return spell_ethereal_cloak;
	if ( !str_cmp( name, "spell_mana_burn" ))			return spell_mana_burn;
	if ( !str_cmp( name, "spell_spirit_syphon" ))		return spell_spirit_syphon;
	if ( !str_cmp( name, "spell_disrupt_reality" ))		return spell_disrupt_reality;
	if ( !str_cmp( name, "spell_mute" ))				return spell_mute;
	if ( !str_cmp( name, "spell_enhance_aura" ))		return spell_enhance_aura;
	if ( !str_cmp( name, "spell_pierce_shadows" ))		return spell_pierce_shadows;
	if ( !str_cmp( name, "spell_enhance_armor"	))		return spell_enhance_armor;
	if ( !str_cmp( name, "spell_enhance_treasure" ))	return spell_enhance_treasure;
	if ( !str_cmp( name, "spell_enhance_weapon" ))		return spell_enhance_weapon;
	if ( !str_cmp( name, "spell_venom_arrow" ))			return spell_venom_arrow;
	if ( !str_cmp( name, "spell_barbed_arrow" ))		return spell_barbed_arrow;
	if ( !str_cmp( name, "spell_numbing_arrow" ))		return spell_numbing_arrow;
	if ( !str_cmp( name, "spell_summon_spirit" ))		return spell_summon_spirit;
	if ( !str_cmp( name, "spell_alchemy_gold" ))		return spell_alchemy_gold;
	if ( !str_cmp( name, "spell_cloud_eyes" ))			return spell_cloud_eyes;
...
DO_FUN *skill_function( char *name )
{
	...
	if ( !str_cmp( name, "do_acro" ))		return do_acro;
	if ( !str_cmp( name, "do_advance" ))		return do_advance;
	if ( !str_cmp( name, "do_advancetier" ))        return do_advancetier;
	...
	if ( !str_cmp( name, "do_ambush" ))		return do_ambush;
	...
	if ( !str_cmp( name, "do_bolt" ))		return do_bolt;
        if ( !str_cmp( name, "do_book" ))		return do_book;
	...
	if ( !str_cmp( name, "do_bumrush" ))		return do_bumrush;
	...
	if ( !str_cmp( name, "do_cast" ))		return do_cast;
  	if ( !str_cmp( name, "do_camouflage" ))		return do_camouflage;
...
//	if ( !str_cmp( name, "do_cmenu" ))		return do_cmenu;
	...
	if ( !str_cmp( name, "do_convert_new_tier" ))	return do_convert_new_tier;
	...
	if ( !str_cmp( name, "do_crush" ))			return do_crush;
	if ( !str_cmp( name, "do_cset" ))		return do_cset;
	if ( !str_cmp( name, "do_cslist" ))		return do_cslist;
	if ( !str_cmp( name, "do_cut"	))		return do_cut;
	break;
    case 'd':
...
//	if ( !str_cmp( name, "do_fire" ))		return do_fire;
	...
	if ( !str_cmp( name, "do_foot_stomp" ))	return do_foot_stomp;
	...
	if ( !str_cmp( name, "do_forcecharmie" ))	return do_forcecharmie;
	...
	if ( !str_cmp( name, "do_fshow" ))		return do_fshow;
        if ( !str_cmp( name, "do_fstore" ))		return do_fstore;
	if ( !str_cmp( name, "do_ftell" ))		return do_ftell;
	if ( !str_cmp( name, "do_fwithdraw" ))		return do_fwithdraw;
	break;
    case 'g':
	//~ if ( !str_cmp( name, "do_gaso" ))		return do_gaso;
	if ( !str_cmp( name, "do_gather" ))		return do_gather;
    if ( !str_cmp( name, "do_gconsent" ))           return do_gconsent;
	...
	if ( !str_cmp( name, "do_grantsight" ))		return do_grantsight;
	if ( !str_cmp( name, "do_grind" ))		return do_grind;
	...
	if ( !str_cmp( name, "do_ignite" ))		return do_ignite;
#ifdef USE_IMC
...
//	if ( !str_cmp( name, "do_liquids" ))		return do_liquids;
	...
	if ( !str_cmp( name, "do_luahelp" ))	return do_luahelp;
    if ( !str_cmp( name, "do_luascript" ))  return do_luascript;
	break;
    case 'm':
#ifdef USE_IMC
	...
	if ( !str_cmp( name, "do_makefol" ))		return do_makefol;
...
//	if ( !str_cmp( name, "do_mmenu" ))		return do_mmenu;
	if (!str_cmp (name, "do_mobmaster" ) )		return do_mobmaster;
	...
	if ( !str_cmp( name, "do_mquest" ))			return do_mquest;
	...
	if ( !str_cmp( name, "do_newscore2" ))		return do_newscore2;
...
//	if ( !str_cmp( name, "do_omenu" ))		return do_omenu;
	if ( !str_cmp( name, "do_ooctalk" ))	return do_ooctalk;
...
/*	if ( !str_cmp( name, "do_opentourney" ))	return do_opentourney; */
	...
	if ( !str_cmp( name, "do_overrun" ))		return do_overrun;
...
//	if ( !str_cmp( name, "do_pagelen" ))		return do_pagelen;
	...
	if ( !str_cmp( name, "do_polish" ))		return do_polish;
	...
	break;
    case 'q':
	if ( !str_cmp( name, "do_qpbuy" ))		return do_qpbuy;
	...
	if ( !str_cmp( name, "do_refund" ))		return do_refund;
...
//	if ( !str_cmp( name, "do_refresh_page" ))	return do_refresh_page;
	...
	if ( !str_cmp( name, "do_reset_economy" ))		return do_reset_economy;
	if ( !str_cmp( name, "do_rest" ))		return do_rest;
	if ( !str_cmp( name, "do_restart_lua_mud"))	return do_restart_lua_mud;
...
#endif
        if ( !str_cmp( name, "do_rinvoke" ))            return do_rinvoke;
...
//	if ( !str_cmp( name, "do_rmenu" ))		return do_rmenu;
	...
	if ( !str_cmp( name, "do_salt_wounds" ))	return do_salt_wounds;
	...
	if ( !str_cmp( name, "do_scoregold" ))		return do_scoregold;
	if ( !str_cmp( name, "do_scoremk" ))		return do_scoremk;
	if ( !str_cmp( name, "do_scoremobm" ))		return do_scoremobm;
	if ( !str_cmp( name, "do_scorepk" ))		return do_scorepk;
	if ( !str_cmp( name, "do_scoreqp" ))		return do_scoreqp;
	if ( !str_cmp( name, "do_scoremp" ))		return do_scoremp;
	if ( !str_cmp( name, "do_scoresp" ))		return do_scoresp;
	if ( !str_cmp( name, "do_scorexp" ))		return do_scorexp;
	...
	if ( !str_cmp( name, "do_setfol" ))		return do_setfol;
	...
	if ( !str_cmp( name, "do_set_random" ))		return do_set_random;
	if ( !str_cmp( name, "do_setslay" ))		return do_setslay;
	if ( !str_cmp( name, "do_setweather" ))		return do_setweather;
	if ( !str_cmp( name, "do_shadow_venom" ))	return do_shadow_venom;
	...
	if ( !str_cmp( name, "do_showfol" ))		return do_showfol;
	...
	if ( !str_cmp( name, "do_slearn" ))		return do_slearn;
	...
	if ( !str_cmp( name, "do_spset" ))		return do_spset;
	if ( !str_cmp( name, "do_spousetalk" ))		return do_spousetalk;
	if ( !str_cmp( name, "do_squest" ))		return do_squest;
	...
	if ( !str_cmp( name, "do_stoke" ))		return do_stoke;
	...
	if ( !str_cmp( name, "do_task" ))		return do_task;
	if ( !str_cmp( name, "do_tailor" ))		return do_tailor;
	...
	if ( !str_cmp( name, "do_unbolt" ))		return do_unbolt;
        if ( !str_cmp( name, "do_unbottle" ))		return do_unbottle;
	...
	if ( !str_cmp( name, "do_vanish" ))		return do_vanish;
	...
	if ( !str_cmp( name, "do_wizmark" ))		return do_wizmark;
...
char *spell_name( SPELL_FUN *spell )
{
    ...
    if ( spell == spell_acidic_weapon )	    return "spell_acidic_weapon";
    if ( spell == spell_animate_dead )	    return "spell_animate_dead";
    if ( spell == spell_astral_walk )	    return "spell_astral_walk";
    if ( spell == spell_bless_object )	    return "spell_bless_object";
    if ( spell == spell_blindness )	    return "spell_blindness";
    if ( spell == spell_bottle )	    return "spell_bottle";
    if ( spell == spell_burning_hands )	    return "spell_burning_hands";
    if ( spell == spell_burning_weapon )    return "spell_burning_weapon";
	...
	if ( spell == spell_disenchant_equipment )	return "spell_disenchant_equipment";
    ...
    if ( spell == spell_dispel_neutral )    return "spell_dispel_neutral";
	if ( spell == spell_draining_weapon )	return "spell_draining_weapon";
    ...
    if ( spell == spell_fear )		    return "spell_fear";
    if ( spell == spell_fireball )	    return "spell_fireball";
    if ( spell == spell_flamestrike )	    return "spell_flamestrike";
    if ( spell == spell_freezing_weapon )   return "spell_freezing_weapon";
    if ( spell == spell_gate )		    return "spell_gate";
    if ( spell == spell_demonic_beast )	    return "spell_demonic_beast";
    if ( spell == spell_daemon_guardian )   return "spell_daemon_guardian";
    if ( spell == spell_summon_golem )	    return "spell_summon_golem";
    if ( spell == spell_conjurers_sword )   return "spell_conjurers_sword";
    if ( spell == spell_golem_plate )	    return "spell_golem_plate";
    if ( spell == spell_golem_fists )       return "spell_golem_fists";
    if ( spell == spell_golem_cloak )       return "spell_golem_cloak";
    if ( spell == spell_golem_shield )      return "spell_golem_shield";
    if ( spell == spell_golem_weapon )      return "spell_golem_weapon";
    if ( spell == spell_alchemy_shield)	    return "spell_alchemy_shield";
    if ( spell == spell_alchemy_armor)           return "spell_alchemy_armor";
    if ( spell == spell_alchemy_light)           return "spell_alchemy_light";
    if ( spell == spell_alchemy_bless)           return "spell_alchemy_bless";
    if ( spell == spell_alchemy_refresh)           return "spell_alchemy_refresh";
    if ( spell == spell_alchemy_fly)           return "spell_alchemy_fly";
    if ( spell == spell_alchemy_waterbreath)           return "spell_alchemy_waterbreath";
    if ( spell == spell_alchemy_serious)           return "spell_alchemy_serious";
    if ( spell == spell_alchemy_poison)           return "spell_alchemy_poison";
    if ( spell == spell_alchemy_blindness)           return "spell_alchemy_blindness";
    if ( spell == spell_alchemy_curse)           return "spell_alchemy_curse";
    if ( spell == spell_alchemy_protect)           return "spell_alchemy_protect";
    if ( spell == spell_alchemy_balance)           return "spell_alchemy_balance";
    if ( spell == spell_alchemy_corrupt)           return "spell_alchemy_corrupt";
    if ( spell == spell_alchemy_level)           return "spell_alchemy_level";
    if ( spell == spell_alchemy_critical)           return "spell_alchemy_critical";
    if ( spell == spell_alchemy_piercebane)           return "spell_alchemy_piercebane";
    if ( spell == spell_alchemy_slashbane)           return "spell_alchemy_slashbane";
    if ( spell == spell_alchemy_eldritch)           return "spell_alchemy_eldritch";
    if ( spell == spell_alchemy_unseen)           return "spell_alchemy_unseen";
    if ( spell == spell_alchemy_travel)           return "spell_alchemy_travel";
    if ( spell == spell_alchemy_sanctuary)           return "spell_alchemy_sanctuary";
    if ( spell == spell_alchemy_heal)           return "spell_alchemy_heal";
    if ( spell == spell_alchemy_escape)           return "spell_alchemy_escape";
    if ( spell == spell_alchemy_stone)           return "spell_alchemy_stone";
    if ( spell == spell_alchemy_sight)           return "spell_alchemy_sight";
    if ( spell == spell_alchemy_demon)           return "spell_alchemy_demon";
    if ( spell == spell_alchemy_shelter)           return "spell_alchemy_shelter";
    if ( spell == spell_alchemy_fire)           return "spell_alchemy_fire";
    if ( spell == spell_alchemy_ice)           return "spell_alchemy_ice";
    if ( spell == spell_alchemy_shock)           return "spell_alchemy_shock";
    if ( spell == spell_alchemy_mana)           return "spell_alchemy_mana";
    if ( spell == spell_alchemy_divinity)           return "spell_alchemy_divinity";
    if ( spell == spell_alchemy_metal)           return "spell_alchemy_metal";
    if ( spell == spell_alchemy_panic)           return "spell_alchemy_panic";
    if ( spell == spell_alchemy_grace)           return "spell_alchemy_grace";
    if ( spell == spell_alchemy_drazuk)           return "spell_alchemy_drazuk";
    if ( spell == spell_alchemy_fury)           return "spell_alchemy_fury";
    if ( spell == spell_alchemy_ashlyn)           return "spell_alchemy_ashlyn";
    if ( spell == spell_alchemy_jaren)           return "spell_alchemy_jaren";
    if ( spell == spell_alchemy_cahel)           return "spell_alchemy_cahel";
    if ( spell == spell_alchemy_vash)           return "spell_alchemy_vash";
    if ( spell == spell_alchemy_paul)           return "spell_alchemy_paul";
    if ( spell == spell_alchemy_sebille)           return "spell_alchemy_sebille";
    if ( spell == spell_armorsmith_standard) return "spell_armorsmith_standard";
    if ( spell == spell_armorsmith_spellward) return "spell_armorsmith_spellward";
    if ( spell == spell_armorsmith_spiked) return "spell_armorsmith_spiked";
    if ( spell == spell_armorsmith_shield) return "spell_armorsmith_shield";
    if ( spell == spell_armorsmith_steel) return "spell_armorsmith_steel";
    if ( spell == spell_armorsmith_magestone) return "spell_armorsmith_magestone";
    if ( spell == spell_armorsmith_bladed) return "spell_armorsmith_bladed";
    if ( spell == spell_armorsmith_dragontear) return "spell_armorsmith_dragontear";
    if ( spell == spell_armorsmith_reinforced) return "spell_armorsmith_reinforced";
    if ( spell == spell_armorsmith_bloodstone) return "spell_armorsmith_bloodstone";
    if ( spell == spell_armorsmith_mirror) return "spell_armorsmith_mirror";
    if ( spell == spell_armorsmith_vitality) return "spell_armorsmith_vitality";
    if ( spell == spell_armorsmith_barbed) return "spell_armorsmith_barbed";
    if ( spell == spell_armorsmith_avatar) return "spell_armorsmith_avatar";
    if ( spell == spell_weaponsmith_etch )  return "spell_weaponsmith_etch";
    if ( spell == spell_weaponsmith_light )  return "spell_weaponsmith_light";
    if ( spell == spell_weaponsmith_weight )  return "spell_weaponsmith_weight";
    if ( spell == spell_weaponsmith_guard )  return "spell_weaponsmith_guard";
    if ( spell == spell_weaponsmith_enhance )  return "spell_weaponsmith_enhance";
    if ( spell == spell_weaponsmith_curve )  return "spell_weaponsmith_curve";
    if ( spell == spell_weaponsmith_spellward )  return "spell_weaponsmith_spellward";
    if ( spell == spell_weaponsmith_loyal )  return "spell_weaponsmith_loyal";
    if ( spell == spell_weaponsmith_swordbane )  return "spell_weaponsmith_swordbane";
    if ( spell == spell_weaponsmith_thirst )  return "spell_weaponsmith_thirst";
    if ( spell == spell_weaponsmith_serpent )  return "spell_weaponsmith_serpent";
    if ( spell == spell_weaponsmith_etherblade )  return "spell_weaponsmith_etherblade";
    if ( spell == spell_weaponsmith_etherguard )  return "spell_weaponsmith_etherguard";
    if ( spell == spell_weaponsmith_dragonslayer )  return "spell_weaponsmith_dragonslayer";
    if ( spell == spell_weaponsmith_ogreslayer )  return "spell_weaponsmith_ogreslayer";
    if ( spell == spell_weaponsmith_swordbreaker )  return "spell_weaponsmith_swordbreaker";
    if ( spell == spell_weaponsmith_serpentkiss )  return "spell_weaponsmith_serpentkiss";
    if ( spell == spell_weaponsmith_devour )  return "spell_weaponsmith_devour";
    ...
    if ( spell == spell_imp_invis )	    return "spell_imp_invis";
    if ( spell == spell_invis )		    return "spell_invis";
    if ( spell == spell_invis_object )	    return "spell_invis_object";
    if ( spell == spell_know_alignment )    return "spell_know_alignment";
    if ( spell == spell_lightning_bolt )    return "spell_lightning_bolt";
    if ( spell == spell_mithril_bolt )	    return "spell_mithril_bolt";
    if ( spell == spell_silver_arrow )	    return "spell_silver_arrow";
    if ( spell == spell_flaming_blast )	    return "spell_flaming_blast";
    ...
    if ( spell == spell_natures_companion ) return "spell_natures_companion";
    ...
    if ( spell == spell_shocking_weapon )   return "spell_shocking_weapon";
    ...
    if ( spell == spell_telescape )	    return "spell_telescape";
    ...
    if ( spell == spell_astral_rift )	    return "spell_astral_rift";
    ...
    if ( spell == spell_enchant_treasure )	return "spell_enchant_treasure";
	if ( spell == spell_magika_armor )		return "spell_magika_armor";
	if ( spell == spell_channel )			return "spell_channel";
	if ( spell == spell_ethereal_cloak )	return "spell_ethereal_cloak";
	if ( spell == spell_mana_burn )			return "spell_mana_burn";
	if ( spell == spell_spirit_syphon )		return "spell_spirit_syphon";
	if ( spell == spell_disrupt_reality )	return "spell_disrupt_reality";
	if ( spell == spell_mute )				return "spell_mute";
	if ( spell == spell_enhance_aura )		return "spell_enhance_aura";
	if ( spell == spell_pierce_shadows )	return "spell_pierce_shadows";
	if ( spell == spell_enhance_armor )		return "spell_enhance_armor";
	if ( spell == spell_enhance_treasure )	return "spell_enhance_treasure";
	if ( spell == spell_enhance_weapon )	return "spell_enhance_weapon";
	if ( spell == spell_venom_arrow )		return "spell_venom_arrow";
	if ( spell == spell_barbed_arrow )		return "spell_barbed_arrow";
	if ( spell == spell_numbing_arrow )		return "spell_numbing_arrow";
	if ( spell == spell_summon_spirit )		return "spell_summon_spirit";
	if ( spell == spell_alchemy_gold )		return "spell_alchemy_gold";
	if ( spell == spell_cloud_eyes )		return "spell_cloud_eyes";
...
char *skill_name( DO_FUN *skill )
{
    ...
    if ( skill == do_acro )		return "do_acro";
    if ( skill == do_advance )		return "do_advance";
    if ( skill == do_advancetier )      return "do_advancetier";
    ...
    if ( skill == do_ambush )		return "do_ambush";
    ...
    if ( skill == do_book )		return "do_book";
    ...
    if ( skill == do_bumrush )		return "do_bumrush";
...
//    if ( skill == do_cmenu )		return "do_cmenu";
	...
	if ( skill == do_convert_new_tier )	return "do_convert_new_tier";
	...
	if ( skill == do_crush )		return "do_crush";
    if ( skill == do_cset )		return "do_cset";
    if ( skill == do_cslist )		return "do_cslist";
	if ( skill == do_cut )		return "do_cut";
...
//    if ( skill == do_fire )		return "do_fire";
    ...
    if ( skill == do_fstore )           return "do_fstore";
    if ( skill == do_ftell )		return "do_ftell";
    if ( skill == do_fwithdraw )	return "do_fwithdraw";
    //~ if ( skill == do_gaso )		return "do_gaso";
	if ( skill == do_gather )	return "do_gather";
    if ( skill == do_gconsent )         return "do_gconsent";
    ...
    if ( skill == do_grantsight )	return "do_grantsight";
	if ( skill == do_grind )		return "do_grind";
	...
	if ( skill == do_ignite )		return "do_ignite";
#ifdef USE_IMC
...
//    if ( skill == do_liquids )		return "do_liquids";
	...
	if ( skill == do_luahelp )		return "do_luahelp";
    if ( skill == do_luascript )    return "do_luascript";
#ifdef USE_IMC
    ...
    if ( skill == do_makefol )		return "do_makefol";
...
//    if ( skill == do_mmenu )		return "do_mmenu";
    if ( skill == do_mobmaster)		return "do_mobmaster";
	...
	if ( skill == do_mquest )		return "do_mquest";
	...
	if ( skill == do_newscore2 )	return "do_newscore2";
...
//    if ( skill == do_omenu )		return "do_omenu";
	if ( skill == do_ooctalk )		return "do_ooctalk";
...
/*  if ( skill == do_opentourney )	return "do_opentourney"; */
    ...
    if ( skill == do_overrun )		return "do_overrun";
...
//    if ( skill == do_pagelen )		return "do_pagelen";
	...
	if ( skill == do_polish )	return "do_polish";
    ...
    if ( skill == do_qpbuy )		return "do_qpbuy";
    ...
    if ( skill == do_refund )		return "do_refund";
...
//    if ( skill == do_refresh_page )	return "do_refresh_page";
    ...
    if ( skill == do_reset_economy )		return "do_reset_economy";
    if ( skill == do_rest )		return "do_rest";
	if ( skill == do_restart_lua_mud )		return "do_restart_lua_mud";
...
#endif
    if ( skill == do_rinvoke )          return "do_rinvoke";
...
//    if ( skill == do_rmenu )		return "do_rmenu";
	...
	if ( skill == do_salt_wounds )	return "do_salt_wounds";
    ...
    if ( skill == do_scoregold )	return "do_scoregold";
    if ( skill == do_scoremk )		return "do_scoremk";
    if ( skill == do_scoremobm )	return "do_scoremobm";
    if ( skill == do_scorepk )		return "do_scorepk";
    if ( skill == do_scoreqp )		return "do_scoreqp";
    if ( skill == do_scoremp )		return "do_scoremp";
    if ( skill == do_scoresp )		return "do_scoresp";
    if ( skill == do_scorexp )		return "do_scorexp";
    ...
    if ( skill == do_setfol )		return "do_setfol";
    ...
    if ( skill == do_setliquid )	return "do_setliquid";
    if ( skill == do_setmixture ) 	return "do_setmixture";
    if ( skill == do_setquest )		return "do_setquest";
    if ( skill == do_setrace )		return "do_setrace";
	if ( skill == do_set_random )	return "do_set_random";
    if ( skill == do_setslay )		return "do_setslay";
    if ( skill == do_setweather )	return "do_setweather";
	if ( skill == do_shadow_venom )	return "do_shadow_venom";
    ...
    if ( skill == do_showfol )		return "do_showfol";
    ...
    if ( skill == do_slearn )		return "do_slearn";
    ...
    if ( skill == do_spousetalk )	return "do_spousetalk";
	if ( skill == do_spset )		return "do_spset";
	if ( skill == do_squest )		return "do_squest";
	...
	if ( skill == do_stoke )		return "do_stoke";
	...
	if ( skill == do_task )		return "do_task";
	if ( skill == do_tailor )	return "do_tailor";
    ...
    if ( skill == do_unbottle )		return "do_unbottle";
	...
	if ( skill == do_vanish )		return "do_vanish";
    ...
    if ( skill == do_wizmark )		return "do_wizmark";
...
bool load_class_file( char *fname )
{
	...
	case 'A':
	    ...
	    KEY( "AttrTertiary",class->attr_tertiary,	fread_number( fp )	);
	    break;
	...
	case 'T':
	    ...
	    KEY( "Thac0base",	class->thac0base,	fread_number( fp )	);
	    KEY( "Thac0mod",	class->thac0mod,	fread_number( fp )	);
	    break;
...
void write_class_file( int cl )
{
    ...
    fprintf( fpout, "AttrTertiary   %d\n",	class->attr_tertiary	);
    fprintf( fpout, "Weapon      %d\n",		class->weapon		);
    fprintf( fpout, "Guild       %d\n",		class->guild		);
    fprintf( fpout, "Skilladept  %d\n",		class->skill_adept	);
    fprintf( fpout, "Thac0base   %d\n",		class->thac0base	);
    fprintf( fpout, "Thac0mod    %d\n",		class->thac0mod	        );
...
bool load_race_file( char *fname )
{
	...
	case 'E':
            if ( !str_cmp( word, "End" ) )
            {
                ...
                if ( ra < 0 || ra >= MAX_RACE )
                {
                    bug( "Load_race_ Race (%s) bad/not found (%d)", race->race_name ? race->race_name : "name not found", ra );
                    if( race_name )
                        STRFREE( race_name );
                    DISPOSE( race );
                    return FALSE;
