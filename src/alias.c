 ...
 ******************************************************/
/******************************************************
 Completely gutted and rewritten to use Lua 2008-02-05
 Darwin @ houseofghouls.org
 ******************************************************/
#include "mud.h"
...
bool check_alias( CHAR_DATA *ch, char *command, char *argument )
{
    ...
    char arg[MSL];
    bool found = FALSE;
	sprintf(arg, "%s %s", command, argument);
    
    call_va(ch->L, "check_alias", "s>i", arg, &found);
