...
/* Blatant hack to change send_to_char and send_to_pager into _color versions */
// #define send_to_char 		send_to_char_color
// #define send_to_pager		send_to_pager_color

/*
 * House of Ghouls Version -Darwin
 */
#define HOG_VERSION_MAJOR	"2"
#define HOG_VERSION_MINOR	"7"
#define HOG_VERSION_REVISION	"6"
...
#define MIS     MAX_INBUF_SIZE

#define HASHSTR			 /* use string hashing */

#define	MAX_LAYERS		 1	/* maximum clothing layers */
...
/*
 *  Dream message display to PCs when they are sleeping.
 *  Change this value if you add more dream messages. -Darwin
 */
//~ #define MAX_DREAM_MESSAGE		24
...
#define LEVEL_MASTER		   (MAX_LEVEL - 14)
...
#define	SECONDS_PER_TICK			 60 // changed from 70 -Darwin - hopefully will speed things up a bit.

#define PULSE_PER_SECOND			  10 // changed from 4
...
#define PULSE_AUCTION				 (24 * PULSE_PER_SECOND)
...
CON_ROLL_STATS,
  ...
  CON_COPYOVER_RECOVER, CON_PLAYING = 0,  CON_GET_DUAL_CLASS, 	CON_CONFIRM_DUAL,
...
typedef enum
{
  ...
  SUB_PROJ_DESC, SUB_SLAYCMSG, SUB_SLAYVMSG, SUB_SLAYRMSG,
...
/* the races */
typedef enum {
  RACE_HUMAN, RACE_ELF, RACE_DWARF, RACE_HALFLING, RACE_PIXIE, RACE_MINOTAUR, 
  RACE_HALF_OGRE, RACE_HALF_ORC, RACE_HALF_TROLL, RACE_HALF_ELF, RACE_GITH, 
  RACE_DROW, RACE_SEA_ELF, RACE_LIZARDMAN, RACE_GNOME, RACE_GHOUL, RACE_GOBLIN,
  RACE_WOLFEN
} race_types;
...
#define CLASS_MONK	    7
#define CLASS_DIABOLIST	    8
#define CLASS_CONJURER	    9 
#define CLASS_JESTER	   10
#define CLASS_SHAMAN	   11
#define CLASS_CHAMPION     12
#define CLASS_BISHOP       13
#define CLASS_ROGUE        14
#define CLASS_ARCHMAGI	   15
...
#define HUM_COST        50
#define GLOW_COST       50
#define NOBURN_COST		5000
#define NAME_COST		100
...
#define LANG_GHOULISH    BV20  /* Ghoul Language */
#define LANG_GNOMISH	 BV21  /* Gnome Language */
#define LANG_MINOTAUR    BV22  /* Minotaur Language */
#define LANG_WOLFEN	 BV23  /* Wolfen Language */
...
#define VALID_LANGS    ( LANG_COMMON | LANG_ELVEN | LANG_DWARVEN | LANG_PIXIE  \
		       | LANG_OGRE | LANG_ORCISH | LANG_TROLLISH | LANG_RODENT \
	 	       | LANG_INSECTOID | LANG_MAMMAL | LANG_REPTILE | LANG_DRAGON \
		       | LANG_SPIRITUAL | LANG_MAGICAL | LANG_GOBLIN  | LANG_GOD \
		       | LANG_ANCIENT | LANG_HALFLING | LANG_GITH | LANG_GHOULISH \
		       | LANG_GNOMISH | LANG_MINOTAUR | LANG_WOLFEN )
/* 18 Languages */
...
struct	class_type
{
    ...
    sh_int	attr_tertiary;		/* tertiary attribute		*/
    int		resist;
    int		suscept;
    int		weapon;			/* First weapon			*/
    int		guild;			/* Vnum of guild room		*/
    int         race_restriction;	/* Racial class restrictions    */
    sh_int	skill_adept;		/* Maximum skill level		*/
    sh_int	thac0base;		/* Thac0 base for class		*/
    sh_int	thac0mod;		/* Thac0 mod per lvl		*/
...
struct	clan_data
{
    ...
    char *	name;		/* Clan name				*/
    char *      namecolor;      /* Clan name in fancy color             */
...
struct	affect_data
{
    ...
    int			modifier;
    EXT_BV		bitvector;
    char *      caster; // name of character that cast the spell -Darwin
};
 ...
 * Defined in #MOBILES.
 */
#define MOB_VNUM_CITYGUARD	   21024
#define MOB_VNUM_VAMPIRE	   80
#define MOB_VNUM_BEAST		   81
#define MOB_VNUM_DAEMON		   4
#define MOB_VNUM_ANIMATED_CORPSE   5
#define MOB_VNUM_RANGER_HAWK	   6
#define MOB_VNUM_RANGER_WOLF	   7
#define MOB_VNUM_RANGER_PANTHER    8
#define MOB_VNUM_RANGER_BEAR       9
...
#define MOB_VNUM_GOLEM		   18
#define MOB_VNUM_ETHEREAL_GUARDIAN	70
#define MOB_VNUM_SUMMONED_SPIRIT	74
/*
 * ACT bits for mobs.
 * Used in #MOBILES.
 */
...
#define ACT_HEALER		  3		/* Pay Healer		*/
#define ACT_BANKER		  4		/* Banker		*/
...
#define ACT_INNKEEPER		  9		/* Innkeeper for Rent	*/
#define ACT_PRACTICE		 10		/* Can practice PC's	*/
#define ACT_IMMORTAL		 11		/* Cannot be killed	*/
#define ACT_BRIBABLE		 12		/* Bribable Mob         */
#define ACT_POLYMORPHED		 13             /* Mob is polymorphed   */
#define ACT_UNDERTAKER		 14		/* Undertaker   	*/
#define ACT_GUARDIAN		 15		/* Protects master	*/
#define ACT_RUNNING		 16		/* Hunts quickly	*/
#define ACT_TRAIN		 17		/* Empty Space   	*/
...
#define ACT_NOQUEST	         22		/* No Quest selection   */
#define ACT_MOBINVIS		 23		/* Like wizinvis	*/
#define ACT_NOASSIST		 24		/* Doesn't assist mobs	*/
#define ACT_ASTRALBLOCK		 25		/* Can never be astraled to or summoned */
#define ACT_PACIFIST             26		/* Doesn't ever fight   */
#define ACT_NOATTACK		 27		/* No physical attacks */
#define ACT_EQUIPPED		 28		/* Has a random item */
#define ACT_BOAT		 29		/* Stays in water on surface */
#define ACT_AQUATIC		 30		/* Stays in all Water	*/
#define ACT_QUESTMASTER		 31		/* Questmaster mob */
#define ACT_AGGRESSIVE_LOW	32	/* Attacks levels 15 and below only -Darwin */
#define ACT_AGGRESSIVE_MID	33	/* Attacks levels 16 and above only -Darwin */
#define ACT_AGGRESSIVE_HIGH	34	/* Attacks levels 30 and above only -Darwin */
#define ACT_NO_CORPSE		35  /* Leaves no corpse when killed -Darwin */
#define ACT_PLANT			36  /* Plant mob -Darwin */
/* 28 acts */
...
typedef enum
{
  ...
  AFF_DETECT_MAGIC, AFF_DETECT_HIDDEN, AFF_IMP_INVIS, AFF_SANCTUARY, 
  AFF_FAERIE_FIRE, AFF_INFRARED, AFF_CURSE, AFF_CORRUPT, AFF_POISON, 
  ...
  AFF_SCRYING, AFF_FIRESHIELD, AFF_SHOCKSHIELD, AFF_DETECT_GOOD, AFF_ICESHIELD, 
  AFF_POSSESS, AFF_BERSERK, AFF_AQUA_BREATH, AFF_RECURRINGSPELL,
  AFF_EMPOWERED, AFF_TONGUES,  AFF_BALANCED, AFF_AURALINK, AFF_UNUSED5,
  AFF_MIGHTY, AFF_CAMO, AFF_DEMONSIGHT, AFF_BOUND, AFF_MUTE,
  MAX_AFFECTED_BY
} affected_by_types;
...
typedef enum
{
  ...
  DFND_FIRESHIELD, DFND_SHOCKSHIELD, DFND_UNUSED1, DFND_UNUSED2, DFND_UNUSED3, 
  DFND_TELEPORT, DFND_UNUSED4, DFND_UNUSED5, DFND_UNUSED6, DFND_UNUSED7, 
  DFND_DISARM, DFND_ICESHIELD, DFND_GRIP, DFND_TRUESIGHT, DFND_UNUSED8,
  DFND_UNUSED9, MAX_DEFENSE_TYPE
} defense_types;
...
#define SF_NOGOD		  BV22  /* Gods can't use		*/
#define SF_NOCHARGE		  BV23  /* cannot be charged		*/
#define SF_GOLEM		  BV24  /* only casts on golems		*/
#define SF_NOGOLEM		  BV25  /* can't be cast on a golem     */
#define SF_NONVERBAL	  BV26  /* spell is not uttered -Darwin */
#define SF_NOCLASS		  BV27  /* spell is not assigned to any class -Darwin */

typedef enum { SS_NONE, SS_DAMAGE, SS_ROD_WANDS, SS_PARA_PETRI,
...
#define OBJ_VNUM_DIAMOND_RING	      4
#define OBJ_VNUM_WEDDING_BAND	      5
#define OBJ_VNUM_BOTTLE		      6
#define OBJ_VNUM_SHARPEN              7
#define OBJ_VNUM_QUESTBAG	      8

#define OBJ_VNUM_WAND_CHARGING	      9	
...
#define OBJ_VNUM_CONJURERSWORD	     20

#define OBJ_VNUM_ALCHEMYSHIELD		29900
#define OBJ_VNUM_ALCHEMYARMOR 		29901
#define OBJ_VNUM_ALCHEMYLIGHT		29902
#define OBJ_VNUM_ALCHEMYBLESS		29903
#define OBJ_VNUM_ALCHEMYREFRESH		29904
#define OBJ_VNUM_ALCHEMYFLY		29905
#define OBJ_VNUM_ALCHEMYWATERBREATH	29906
#define OBJ_VNUM_ALCHEMYSERIOUS		29907
#define OBJ_VNUM_ALCHEMYPOISON		29908
#define OBJ_VNUM_ALCHEMYBLINDNESS	29909
#define OBJ_VNUM_ALCHEMYCURSE		29910
#define OBJ_VNUM_ALCHEMYPROTECT		29911
#define OBJ_VNUM_ALCHEMYBALANCE		29912
#define OBJ_VNUM_ALCHEMYCORRUPT		29913
#define OBJ_VNUM_ALCHEMYLEVEL		29914
#define OBJ_VNUM_ALCHEMYCRITICAL	29915
#define OBJ_VNUM_ALCHEMYPIERCEBANE	29916
#define OBJ_VNUM_ALCHEMYSLASHBANE	29917
#define OBJ_VNUM_ALCHEMYELDRITCH	29918
#define OBJ_VNUM_ALCHEMYUNSEEN		29919
#define OBJ_VNUM_ALCHEMYTRAVEL		29920
#define OBJ_VNUM_ALCHEMYSANCTUARY	29921
#define OBJ_VNUM_ALCHEMYHEAL		29922
#define OBJ_VNUM_ALCHEMYESCAPE		29923
#define OBJ_VNUM_ALCHEMYSTONE		29924
#define OBJ_VNUM_ALCHEMYSIGHT		29925
#define OBJ_VNUM_ALCHEMYDEMON		29926
#define OBJ_VNUM_ALCHEMYSHELTER		29927
#define OBJ_VNUM_ALCHEMYFIRE		29928
#define OBJ_VNUM_ALCHEMYICE		29929
#define OBJ_VNUM_ALCHEMYSHOCK		29930
#define OBJ_VNUM_ALCHEMYMANA		29931
#define OBJ_VNUM_ALCHEMYDIVINITY	29932
#define OBJ_VNUM_ALCHEMYMETAL		29933
#define OBJ_VNUM_ALCHEMYPANIC		29934
#define OBJ_VNUM_ALCHEMYGRACE		29935
#define OBJ_VNUM_ALCHEMYDRAZUK		29936
#define OBJ_VNUM_ALCHEMYFURY		29937
#define OBJ_VNUM_ALCHEMYASHLYN		29938
#define OBJ_VNUM_ALCHEMYJAREN		29939
#define OBJ_VNUM_ALCHEMYCAHEL		29940
#define OBJ_VNUM_ALCHEMYVASH		29941
#define OBJ_VNUM_ALCHEMYPAUL		29942
#define OBJ_VNUM_ALCHEMYSEBILLE 	29943

#define OBJ_VNUM_MUSHROOM	     26
#define OBJ_VNUM_ROAST		     27
#define OBJ_VNUM_BREAD		     28
#define OBJ_VNUM_CHICKEN             29
...
#define OBJ_VNUM_VR_LOCKER		90

/* job skill items -saved in limbo.are -Darwin */
#define OBJ_VNUM_GATHERED_STICK		70
#define OBJ_VNUM_GATHERED_BRANCH	71
#define OBJ_VNUM_GATHERED_LOG		72
#define OBJ_VNUM_MINED_MINERAL		73
#define OBJ_VNUM_MINED_GEM		    74
#define OBJ_VNUM_MINED_COAL			75
#define OBJ_VNUM_SLAB				76
#define OBJ_VNUM_GEM_POWDER			77
#define OBJ_VNUM_GEM_CUT			68
#define OBJ_VNUM_GEM_POLISHED		67
#define OBJ_VNUM_HANDMADE_ARMOR		78
#define OBJ_VNUM_HANDMADE_WEAPON    69
#define OBJ_VNUM_HANDMADE_TREASURE  79

/* Academy eq */
#define OBJ_VNUM_SCHOOL_MACE	  10315
#define OBJ_VNUM_SCHOOL_DAGGER	  10312
#define OBJ_VNUM_SCHOOL_SWORD	  10313
#define OBJ_VNUM_SCHOOL_CLAW	  10308
#define OBJ_VNUM_SCHOOL_VEST	  10332
#define OBJ_VNUM_SCHOOL_CLUB      10329
#define OBJ_VNUM_SCHOOL_SHIELD	  10310
#define OBJ_VNUM_SCHOOL_BANNER    10311
#define OBJ_VNUM_SCHOOL_AXE	  10336

/* Questmaster information */
#define MAX_QDATA 50 /* For Questmaster, set this to however many slots we need -Drazuk */
...
typedef enum
{
  ...
  ITEM_SHOVEL, ITEM_SALVE, ITEM_COOK, ITEM_KEYRING, ITEM_COMP, ITEM_ARTWEAPON,
  ITEM_ARTARMOR, ITEM_ARTTREASURE, ITEM_ARTWORN, ITEM_ARTLIGHT, ITEM_DRINK_MIX,
  ITEM_CHANCE
} item_types;
...
typedef enum
{
  ...
  ITEM_PROTOTYPE, ITEM_NOLOCATE, ITEM_GROUNDROT, ITEM_LOOTABLE, ITEM_IDED, ITEM_GOOD,
  ITEM_QUEST, ITEM_NOBURN, ITEM_2HAND, ITEM_NOQUEST, ITEM_GOLEM,
  ITEM_CONJURER, ITEM_ENCHANTED, ITEM_NOJUNK, ITEM_RANDOM, ITEM_PET_EQ, 
  MAX_ITEM_FLAG
} item_extra_flags;
...
#define ITEM_WEAR_BODY		BV06
#define ITEM_WEAR_ARMS		BV07
#define ITEM_WEAR_WRIST		BV08
#define ITEM_WEAR_HANDS  	BV09
#define ITEM_WEAR_FINGER	BV10
#define ITEM_WEAR_ABOUT		BV11
#define ITEM_WEAR_BACK		BV12
#define ITEM_WEAR_WAIST		BV13
#define ITEM_WEAR_LEGS		BV14
#define ITEM_WEAR_ANKLE		BV15
#define ITEM_WEAR_FEET		BV16
#define ITEM_WIELD		BV17
#define ITEM_DUAL_WIELD		BV18
#define ITEM_WEAR_SHIELD	BV19
#define ITEM_HOLD		BV20
#define ITEM_WEAR_WWP		BV21
#define ITEM_WEAR_AURA		BV22
...
typedef enum
{
  ...
  APPLY_HITROLL, APPLY_DAMROLL, APPLY_SAVING_DAMAGE, APPLY_SAVING_ROD,
  ...
  APPLY_TELEDELAY, APPLY_CAMO, APPLY_AMBUSH, APPLY_SPIRITSHIELD, APPLY_SPELLDAM,
  APPLY_JUMP, APPLY_WAIT, APPLY_MUTE,
  MAX_APPLY_TYPE
} apply_types;
...
#define ROOM_VNUM_T1		  21002
#define ROOM_VNUM_T2		  21003
#define ROOM_VNUM_T3		  21004
#define ROOM_VNUM_T4		  21005
#define ROOM_VNUM_T5		  21006
#define ROOM_VNUM_T6	          21007
#define ROOM_VNUM_T7		  21008
#define ROOM_VNUM_T8		  21009
#define ROOM_VNUM_ALTAR		  21001 
#define ROOM_VNUM_SCHOOL	  10300
#define ROOM_AUTH_START		    100
#define ROOM_VNUM_HALLOFFALLEN    21001
#define ROOM_VNUM_DONATION        21007
#define ROOM_VNUM_DONATIONTWO     21007
...
#define ROOM_HEALING		BV04
#define ROOM_MENTAL		BV05
...
#define ROOM_NORUN		BV27
#define ROOM_LOCKER		BV28
#define ROOM_BLOODROOM		BV29
 ...
 * Item values
 */
#define ARMOR_CURRENT_AC        0
#define ARMOR_ORIGINAL_AC       1

#define CONTAINER_CAPACITY      0
#define CONTAINER_FLAGS         1
#define CONTAINER_KEY           2
#define CONTAINER_CONDITION     3

#define DRINKCON_CAPACITY       0
#define DRINKCON_QUANTITY       1
#define DRINKCON_LIQUID         2
#define DRINKCON_POISON         3

#define FOOD_VALUE              0
#define FOOD_CONDITION          1
#define FOOD_POISON             3

#define HERB_CHARGES            1
#define HERB_NUMBER             2

#define KEY_LOCK                0

#define KEYRING_CAPACITY        0

#define LEVER_FLAGS             0
#define LEVER_VNUMSN            1
#define LEVER_VNUM              2
#define LEVER_VNUMVALUE         3

#define LIGHT_HOURS             2

#define MONEY_AMOUNT            0
#define MONEY_TYPE              1
...
#define PILL_SN2                2
#define PILL_SN3                3
#define PILL_FOODVALUE          4

#define PIPE_CAPACITY           0
#define PIPE_DRAWS              1
#define PIPE_HERB               2
#define PIPE_FLAGS              3

#define POTION_LEVEL            0
#define POTION_SN1              1
#define POTION_SN2              2
#define POTION_SN3              3

#define SALVE_LEVEL             0
#define SALVE_CHARGES           1
#define SALVE_MAX_CHARGES       2
#define SALVE_DELAY             3
#define SALVE_SN1               4
#define SALVE_SN2               5

#define SCROLL_LEVEL            0
#define SCROLL_SN1              1
#define SCROLL_SN2              2
#define SCROLL_SN3              3

#define STAFF_LEVEL             0
#define STAFF_MAX_CHARGES       1
#define STAFF_CHARGES           2
#define STAFF_SN                3

#define SWITCH_FLAGS            0
#define SWITCH_VNUMSN           1
#define SWITCH_VNUM             2
#define SWITCH_VNUMVAL          3

#define TRAP_CHARGES            0
#define TRAP_TYPE               1
#define TRAP_LEVEL              2
#define TRAP_FLAGS              3

#define TREASURE_TYPE           0
#define TREASURE_CONDITION      1

#define WAND_LEVEL              0
#define WAND_MAX_CHARGES        1
#define WAND_CHARGES            2
#define WAND_SN                 3

#define WEAPON_CONDITION        0
#define WEAPON_NUMDICE          1
#define WEAPON_SIZEDICE         2
#define WEAPON_TYPE             3

#define MISSILE_CONDITION       0
#define MISSILE_DAM_BONUS       2
#define MISSILE_TYPE            3
#define MISSILE_RANGE           4

#define QUIVER_CAPACITY         0
#define QUIVER_FLAGS            1
#define QUIVER_KEY              2
#define QUIVER_CONDITION        3

#define FURNITURE_TYPE          2

#define NPC_CORPSE_TIMER        2
#define NPC_CORPSE_WEIGHT       3

#define PC_CORPSE_PK            1
#define PC_CORPSE_LEVEL         5

#define ENCHANT_VALUE           5

#define COMPONENT_USES          0
/*
 * Sector types.
 * Used in #ROOMS.
 */
...
typedef enum
{
  ...
  WEAR_NECK_1, WEAR_NECK_2, WEAR_BODY, WEAR_ARMS, WEAR_WRIST_L, WEAR_WRIST_R,
  WEAR_HANDS, WEAR_FINGER_L, WEAR_FINGER_R, WEAR_ABOUT, WEAR_BACK, WEAR_WAIST,
  WEAR_LEGS, WEAR_ANKLE_L, WEAR_ANKLE_R, WEAR_FEET, WEAR_WIELD, WEAR_DUAL_WIELD,
  WEAR_SHIELD, WEAR_HOLD, WEAR_WWP_1, WEAR_WWP_2, WEAR_AURA, MAX_WEAR
} wear_locations;
...
typedef enum
{
  ...
  PLR_THIEF, PLR_KILLER, PLR_BULLY, PLR_ANSI, PLR_RIP, PLR_NICE, PLR_FLEE, 
  PLR_AUTOGOLD, PLR_AUTOMAP, PLR_AFK, PLR_INVISPROMPT, PLR_QUESTOR,
  PLR_AUTOGLANCE, PLR_COMPASS, PLR_CONSENT, PLR_SEEDAM, PLR_STALK, PLR_EXEMPT,
  PLR_GODSIGHT, PLR_MOBM, PLR_TIER, PLR_GAMBLER, PLR_MOBM_EXPERT, PLR_AUTOUPDATE_PROMPT,
  PLR_AUTOASSIST, PLR_ABBAFFS, PLR_TIER_CONVERT, PLR_SQUESTOR, PLR_MQUESTOR,
  PLR_SHORTWHO
} player_flags;
...
typedef enum
{
  ...
  TIMER_FEARSPELL, TIMER_STALK, TIMER_THIEF, TIMER_PKER
} timer_types;
...
#define CHANNEL_MUSE		   BV10
#define CHANNEL_FTELL		   BV11
#define CHANNEL_BUILD		   BV12
#define CHANNEL_THINK		   BV13
...
//******************************************************
        int                             mobmaster; 
        sh_int                          mobmastercomplete;
        sh_int                          mobmticks;
        sh_int                          nextmobm;
        sh_int                          mobmcountdown;
//******************************************************
    sh_int		tmplevel;      /* These two for mortality command */
    sh_int		tmptrust;
    sh_int		mobinvis;	/* Mobinvis level SB */
    int		        home_vnum;  /* hotboot tracker */
    //~ sh_int		cmd_recurse;   /* for Alias */
...
struct	pc_data
{
    CHAR_DATA *		pet;
    CLAN_DATA *		clan;
    COUNCIL_DATA * 	council; // Remove this -Darwin
    AREA_DATA *		area;
    DEITY_DATA *	deity; // Remove this -Darwin
    //~ char *		homepage; // Remove this -Darwin
    char *		clan_name;
    char * 		council_name; // Remove this -Darwin
    char *		deity_name; // Remove this -Darwin
    char *		pwd;
    char *		bamfin;
    char *		bamfout;
    ...
    char *		stalking;       /* Who the charater is stalking    */
    ...
    int			scoreqp;
    int			scoremk;
	int			scorexp;	/* score exp */
	int			scoresp;	/* score skill points */
	int			scoremp;	/* score magic points */
    sh_int		favor;		/* deity favor */ // Remove this -Darwin
    sh_int		charmies;	/* Number of Charmies */
    int			auth_state; // Remove this -Darwin
    ...
    //~ long	imc_deaf;    /* IMC channel def flags */ // Remove this -Darwin
    //~ long	imc_allow;   /* IMC channel allow flags */ // Remove this -Darwin
    //~ long	imc_deny;    /* IMC channel deny flags */ // Remove this -Darwin
    //~ char *	rreply;      /* IMC reply-to */ // Remove this -Darwin
    //~ char *	rreply_name; /* IMC reply-to shown to char */ // Remove this -Darwin
    //~ char *	ice_listen;  /* ICE channels */  // Remove this -Darwin
    ...
    char *      questmobold;    /* Questmaster */
    char *      questitem;      /* Questmaster */
    int		balance;	/* Banking */
    ...
    sh_int              locker_vnum;
    //~ sh_int		house_vnum;  // Remove this -Darwin
    int		        rent; /* Saves amount of daily rent built up - Samson 1-24-00 */
    //~ bool		norares; /* Toggled so we can tell the PC he ran out of money - Samson 1-24-00 */ // Remove this -Darwin
    //~ bool		autorent; /* Is this PC an autorent? - Samson 7-27-00 */ // Remove this -Darwin
    char *	pkvictim;
    int		mobdeathvnum;
	int		pc_id; /* ID# */
	sh_int	skillpoints;	/* skill quest points -Darwin */
	sh_int	magicpoints;	/* magic quest points -Darwin */
};
...
typedef enum
{
   ...
   DAM_BLAST, DAM_POUND, DAM_CRUSH, DAM_HACK, DAM_BITE,
   DAM_PIERCE, DAM_PSLICE, DAM_BOLT, DAM_ARROW, DAM_DART,
   DAM_STONE, DAM_PSLASH, DAM_ASLICE, DAM_ASLASH, DAM_EHIT,
   DAM_SBASH, DAM_TEAR, DAM_RIP, DAM_PSTAB, DAM_APIERCE
} damage_types;
...
struct	obj_data
{
    ...
    int			tmag;	/* for RoS magic flags */
	int			obj_id;		/* unique id# for item loaded dynamically -Darwin */
};
...
struct	system_data
{
	...
	int PlayerIndex; /* Running count of new players used to ID characters -Darwin 2006-06-29 */
};
...
struct	room_index_data
{
    ...
    AFFECT_DATA *	last_affect;	    /*		..		*/
    MAP_DATA *		map;		    /* maps */
    //~ PLANE_DATA *	plane;		    /* do it by room rather than area */ // Remove this -Darwin
    MPROG_ACT_LIST *	mpact;		    /* mudprogs */
    int			mpactnum;	    /* mudprogs */
	...
	//~ int			job_items[10];  /* array to hold job related items -Darwin*/
};
...
extern  sh_int  gsn_enhanced_hit;
...
extern  sh_int  gsn_magical;
extern  sh_int  gsn_ancient;
extern  sh_int  gsn_spiritual;
extern  sh_int  gsn_rodent;
extern  sh_int  gsn_insectoid;
extern  sh_int  gsn_reptile;
extern  sh_int  gsn_dragon;
extern  sh_int  gsn_gith;
extern  sh_int  gsn_ghoulish;
extern  sh_int  gsn_gnomish;

/* jobs -Darwin */
extern  sh_int  gsn_gather;
extern  sh_int  gsn_ignite;
extern  sh_int  gsn_skin;
extern  sh_int  gsn_mine;
extern	sh_int	gsn_tan;
...
extern  sh_int  gsn_tailor;

extern	sh_int	gsn_magika_armor;
extern	sh_int	gsn_salt_wounds;
extern	sh_int	gsn_shadow_venom;
extern	sh_int	gsn_enhanced_dual_wield;
/*
...
#define QUICKMATCH(p1, p2)	(long int) (p1) == (long int) (p2)
...
#define WAS_IMMORTAL(ch)	(!IS_NPC((ch)) && (ch)->tmplevel > 51)
#define IS_GODLY(ch)		(get_trust((ch)) >= 60)
#define IS_DEMI(ch)		(!IS_NPC((ch)) && get_trust((ch)) > 51 && get_trust((ch)) < 60)
#define IS_TIER(ch)             (!IS_NPC((ch)) && !IS_IMMORTAL((ch)) && xIS_SET((ch)->act, PLR_TIER))
#define IS_HERO(ch)             (get_trust((ch)) >= LEVEL_HERO || xIS_SET( ((ch))->act, PLR_TIER ) )
#define IS_AFFECTED(ch, sn)	(xIS_SET((ch)->affected_by, (sn)))
#define IS_MOBM(ch)		   (IS_SET((ch)->act, PLR_MOBM) || IS_SET((ch)->act, PLR_MOBM_EXPERT))
#define HAS_BODYPART(ch, part)	((ch)->xflags == 0 || IS_SET((ch)->xflags, (part)))

#define IS_MAGE(ch)             ((ch)->class == 0 || (ch)->dualclass == 0)
#define IS_CLERIC(ch)           ((ch)->class == 1 || (ch)->dualclass == 1)
#define IS_THIEF(ch)            ((ch)->class == 2 || (ch)->dualclass == 2)
#define IS_WARRIOR(ch)          ((ch)->class == 3 || (ch)->dualclass == 3)
#define IS_THUG(ch)             ((ch)->class == 4 || (ch)->dualclass == 4)
#define IS_DRUID(ch)            ((ch)->class == 5 || (ch)->dualclass == 5)
#define IS_RANGER(ch)           ((ch)->class == 6 || (ch)->dualclass == 6)
#define IS_MONK(ch)             ((ch)->class == 7 || (ch)->dualclass == 7)
#define IS_DIABOLIST(ch)        ((ch)->class == 8 || (ch)->dualclass == 8)
#define IS_CONJURER(ch)		((ch)->class == 9 || (ch)->dualclass == 9)
#define IS_JESTER(ch)           ((ch)->class == 10 || (ch)->dualclass == 10)
#define IS_SHAMAN(ch)		((ch)->class == 11 || (ch)->dualclass == 11)
#define IS_CHAMPION(ch)		((ch)->class == 12)
#define IS_BISHOP(ch)		((ch)->class == 13)
#define IS_ROGUE(ch)		((ch)->class == 14)
#define IS_ARCHMAGI(ch)		((ch)->class == 15)
#define IS_DUAL(ch)		( !IS_TIER((ch)) && ((ch)->class) != ((ch)->dualclass) )
#define CH_LEVEL(ch)	( IS_TIER((ch)) ? 50 + ((ch)->level/10) : (ch)->level )

#define IS_FIGHTER(ch)		(IS_THIEF((ch))			\
							 ||	IS_WARRIOR((ch))	\
							 || IS_THUG((ch))		\
							 || IS_RANGER((ch))		\
							 || IS_MONK((ch))		\
...
#define IS_CASTER(ch)		(IS_MAGE((ch))			\
							 || IS_DRUID((ch))		\
							 || IS_DIABOLIST((ch))	\
							 || IS_CONJURER((ch))	\
							 || IS_SHAMAN((ch))		\
...
#define IS_CROOK(ch)		(!IS_NPC((ch))        \
				&& ( IS_THIEF((ch))             \
				||   IS_THUG((ch))              \
				||   IS_RANGER((ch))           ))

#define IS_2HANDER(ch)		( IS_NPC(ch) ||	(!IS_NPC(ch) && (IS_IMMORTAL(ch) \
				|| (IS_CLERIC((ch))		         \
				||  IS_WARRIOR((ch))		         \
				||  IS_THUG((ch))		         \
				||  IS_RANGER((ch))		         \
...
#define IS_NONMETAL(ch)		( !IS_NPC(ch) && !IS_IMMORTAL(ch) 				 \
				  && (IS_MAGE((ch))     \
				  ||  IS_THIEF((ch))   \
				  ||  IS_DRUID((ch))   \
				  ||  IS_RANGER((ch)) \
...
#define GET_DAMROLL(ch)		( UMIN( (ch)->damroll, ( IS_TIER(ch) ? (50 + ch->level / 5) * 5 : ch->level * 5 ) )   \
				    +(ch)->damplus			    \
				    +str_app[get_curr_str(ch)].todam	    \
				    +(((ch)->mental_state > 5		    \
				    &&(ch)->mental_state < 15) ? 1 : 0)	\
					+(IS_NPC((ch))?0:(int)((ch)->pcdata->skillpoints/350)) )

#define GET_SPELLDAM(ch) 	( UMIN( (0 + (ch)->spelldam), (IS_TIER(ch) ? (50 + ch->level / 5) * 5 : ch->level * 5) ) \
							 +(IS_NPC((ch))?0:(int)((ch)->pcdata->magicpoints/350)) )
...
#define CAN_PKILL(ch)           (IS_PKILL(ch) && ch->level >= 5 && get_age( ch ) >= 17 )
...
#define WAIT_STATE(ch, npulse) ((ch)->wait=(!IS_NPC(ch)&&ch->pcdata->nuisance&&\
			      ...
			      UMAX((ch)->wait, (IS_GODLY(ch) ? 0 :(npulse))))
...
#define IS_PET(ch)      (IS_NPC((ch)) && xIS_SET((ch)->act, ACT_PET))
...
#define ECONOMY_DIR		"../economy/"	/* for saving economy stats -Darwin */
#define GRUB_DIR		"../grub/"		/* Grub -Darwin */
...
#define IS_WEAPON(o)  ( (o)->item_type == ITEM_WEAPON || (o)->item_type == ITEM_ARTWEAPON )
#define IS_LIGHT(o)  ((o)->item_type == ITEM_LIGHT || (o)->item_type == ITEM_ARTLIGHT)
#define IS_ARMOR(o)  ((o)->item_type == ITEM_ARMOR || (o)->item_type == ITEM_ARTARMOR)
#define IS_TREASURE(o)  ((o)->item_type == ITEM_TREASURE || (o)->item_type == ITEM_ARTTREASURE)
#define IS_MONK_WEAPON(o)  ( (o)->value[3] == 0 || (o)->value[3] == 5 || (o)->value[3] == 22 || (o)->value[3] == 23 )
#define PET_CAN_WEAR(obj)  (IS_OBJ_STAT((obj), ITEM_PET_EQ))

#define EMPTY_STRING(txt)   ((txt) == NULL || (txt)[0] == '\0')
...
#define IS_SAME_STRING(txta, txtb)	( !str_cmp( (txta), (txtb) ) )
...
extern	char *	const			attack_table	[26];

extern  char ** const			s_message_table [26];
extern	char ** const			p_message_table	[26];
...
//~ extern	char *	const	dream_message	[];
...
extern      OBJ_DATA      * save_mob_equipment[MAX_WEAR][MAX_LAYERS];
...
extern		CHAR_DATA	  *	get_mob args((int vnum));
extern		OBJ_DATA	  *	obj_by_vnum args((int vnum));
...
DECLARE_DO_FUN( do_convert_new_tier );
...
DECLARE_DO_FUN( do_fdeposit	);
DECLARE_DO_FUN(	do_fill		);
DECLARE_DO_FUN(	do_findnote	);
DECLARE_DO_FUN( do_finfo	);
DECLARE_DO_FUN(	do_fire		);
DECLARE_DO_FUN(	do_fixchar	);
DECLARE_DO_FUN( do_fixcharmie   );
DECLARE_DO_FUN( do_fixed	);
DECLARE_DO_FUN( do_fixmobm	);
DECLARE_DO_FUN(	do_flee		);
DECLARE_DO_FUN( do_foldarea	);
DECLARE_DO_FUN(	do_follow	);
DECLARE_DO_FUN( do_foot_stomp );
DECLARE_DO_FUN( do_for      );
DECLARE_DO_FUN(	do_force	);
DECLARE_DO_FUN( do_forcecharmie );
...
DECLARE_DO_FUN( do_ftell	);
DECLARE_DO_FUN( do_fwithdraw	);
//~ DECLARE_DO_FUN(	do_gaso	        );
DECLARE_DO_FUN(	do_gather	);
DECLARE_DO_FUN( do_gconsent	);
...
DECLARE_DO_FUN( do_grantsight	);
DECLARE_DO_FUN( do_grind    );
...
DECLARE_DO_FUN( do_reset_economy );
...
DECLARE_DO_FUN( do_scoremobm    );
DECLARE_DO_FUN( do_scorepk	);
DECLARE_DO_FUN( do_scoremk	);
DECLARE_DO_FUN( do_scoregold	);
DECLARE_DO_FUN( do_scoreqp	);
DECLARE_DO_FUN( do_scoremp	);
DECLARE_DO_FUN( do_scoresp	);
DECLARE_DO_FUN( do_scorexp	);
DECLARE_DO_FUN( do_scribe       );
DECLARE_DO_FUN( do_search	);
DECLARE_DO_FUN(	do_sedit	);
DECLARE_DO_FUN(	do_sell		);
DECLARE_DO_FUN( do_set_boot_time);
DECLARE_DO_FUN( do_setfol	);
DECLARE_DO_FUN( do_setclass	);
DECLARE_DO_FUN( do_setcouncil   );
DECLARE_DO_FUN( do_setdeity	);
DECLARE_DO_FUN( do_setrace	);
DECLARE_DO_FUN( do_set_random	);
DECLARE_DO_FUN( do_setweather	);
DECLARE_DO_FUN( do_shadow_venom	);
...
DECLARE_SPELL_FUN( 	spell_acidic_weapon	);
DECLARE_SPELL_FUN(	spell_animate_dead	);
DECLARE_SPELL_FUN(	spell_astral_walk	);
DECLARE_SPELL_FUN(	spell_bless_object      );
DECLARE_SPELL_FUN(	spell_blindness		);
DECLARE_SPELL_FUN(	spell_bottle		);
DECLARE_SPELL_FUN(	spell_burning_hands	);
DECLARE_SPELL_FUN(  spell_burning_weapon    );
...
DECLARE_SPELL_FUN(	spell_demonic_beast	);
DECLARE_SPELL_FUN(	spell_daemon_guardian   );
DECLARE_SPELL_FUN(	spell_demonsight	);
DECLARE_SPELL_FUN(	spell_detect_poison	);
DECLARE_SPELL_FUN(	spell_dispel_evil	);
DECLARE_SPELL_FUN(	spell_dispel_good       );
DECLARE_SPELL_FUN(	spell_dispel_magic	);
DECLARE_SPELL_FUN(	spell_dispel_neutral    );
DECLARE_SPELL_FUN(  spell_disenchant_equipment  );
DECLARE_SPELL_FUN(  spell_disenchant_weapon );
DECLARE_SPELL_FUN(	spell_draining_weapon );
...
DECLARE_SPELL_FUN(	spell_freezing_weapon	);
...
DECLARE_SPELL_FUN(	spell_imp_invis		);
DECLARE_SPELL_FUN(	spell_invis		);
DECLARE_SPELL_FUN(	spell_invis_object	);
DECLARE_SPELL_FUN(	spell_know_alignment	);
DECLARE_SPELL_FUN(	spell_lightning_bolt	);
DECLARE_SPELL_FUN(	spell_mithril_bolt	);
DECLARE_SPELL_FUN(	spell_silver_arrow	);
DECLARE_SPELL_FUN(	spell_flaming_blast	);
DECLARE_SPELL_FUN(	spell_locate_object	);
DECLARE_SPELL_FUN(	spell_magic_missile	);
DECLARE_SPELL_FUN(	spell_mist_walk		);
DECLARE_SPELL_FUN( 	spell_natures_companion );
...
DECLARE_SPELL_FUN(	spell_alchemy_shield	);
DECLARE_SPELL_FUN(  spell_alchemy_armor	);
DECLARE_SPELL_FUN(  spell_alchemy_light	);
DECLARE_SPELL_FUN(  spell_alchemy_bless	);
DECLARE_SPELL_FUN(  spell_alchemy_refresh	);
DECLARE_SPELL_FUN(  spell_alchemy_fly	);
DECLARE_SPELL_FUN(  spell_alchemy_waterbreath );
DECLARE_SPELL_FUN(  spell_alchemy_serious	);
DECLARE_SPELL_FUN(  spell_alchemy_poison	);
DECLARE_SPELL_FUN(  spell_alchemy_blindness );
DECLARE_SPELL_FUN(  spell_alchemy_curse	);
DECLARE_SPELL_FUN(  spell_alchemy_protect	);
DECLARE_SPELL_FUN(  spell_alchemy_balance	);
DECLARE_SPELL_FUN(  spell_alchemy_corrupt	);
DECLARE_SPELL_FUN(  spell_alchemy_level	);
DECLARE_SPELL_FUN(  spell_alchemy_critical  );
DECLARE_SPELL_FUN(  spell_alchemy_piercebane );
DECLARE_SPELL_FUN(  spell_alchemy_slashbane );
DECLARE_SPELL_FUN(  spell_alchemy_eldritch 	);
DECLARE_SPELL_FUN(  spell_alchemy_unseen	);
DECLARE_SPELL_FUN(  spell_alchemy_travel	);
DECLARE_SPELL_FUN(  spell_alchemy_sanctuary );
DECLARE_SPELL_FUN(  spell_alchemy_heal	);
DECLARE_SPELL_FUN(  spell_alchemy_escape	);
DECLARE_SPELL_FUN(  spell_alchemy_stone	);
DECLARE_SPELL_FUN(  spell_alchemy_sight	);
DECLARE_SPELL_FUN(  spell_alchemy_demon	);
DECLARE_SPELL_FUN(  spell_alchemy_shelter	);
DECLARE_SPELL_FUN(  spell_alchemy_fire	);
DECLARE_SPELL_FUN(  spell_alchemy_ice	);
DECLARE_SPELL_FUN(  spell_alchemy_shock	);
DECLARE_SPELL_FUN(  spell_alchemy_mana	);
DECLARE_SPELL_FUN(  spell_alchemy_divinity	);
DECLARE_SPELL_FUN(  spell_alchemy_metal	);
DECLARE_SPELL_FUN(  spell_alchemy_panic	);
DECLARE_SPELL_FUN(  spell_alchemy_grace	);
DECLARE_SPELL_FUN(  spell_alchemy_drazuk	);
DECLARE_SPELL_FUN(  spell_alchemy_fury	);
DECLARE_SPELL_FUN(  spell_alchemy_ashlyn	);
DECLARE_SPELL_FUN(  spell_alchemy_jaren	);
DECLARE_SPELL_FUN(  spell_alchemy_cahel	);
DECLARE_SPELL_FUN(  spell_alchemy_vash	);
DECLARE_SPELL_FUN(  spell_alchemy_paul	);
DECLARE_SPELL_FUN(  spell_alchemy_sebille	);
DECLARE_SPELL_FUN(	spell_armorsmith_standard );
DECLARE_SPELL_FUN(  spell_armorsmith_spellward );
DECLARE_SPELL_FUN(  spell_armorsmith_spiked );
DECLARE_SPELL_FUN(  spell_armorsmith_shield );
DECLARE_SPELL_FUN(  spell_armorsmith_steel );
DECLARE_SPELL_FUN(  spell_armorsmith_magestone );
DECLARE_SPELL_FUN(  spell_armorsmith_bladed );
DECLARE_SPELL_FUN(  spell_armorsmith_dragontear );
DECLARE_SPELL_FUN(  spell_armorsmith_reinforced );
DECLARE_SPELL_FUN(  spell_armorsmith_bloodstone );
DECLARE_SPELL_FUN(  spell_armorsmith_mirror );
DECLARE_SPELL_FUN(  spell_armorsmith_vitality );
DECLARE_SPELL_FUN(  spell_armorsmith_barbed );
DECLARE_SPELL_FUN(  spell_armorsmith_avatar );
DECLARE_SPELL_FUN(	spell_weaponsmith_etch  );
DECLARE_SPELL_FUN(  spell_weaponsmith_light );
DECLARE_SPELL_FUN(  spell_weaponsmith_weight);
DECLARE_SPELL_FUN(  spell_weaponsmith_guard  );
DECLARE_SPELL_FUN(  spell_weaponsmith_enhance  );
DECLARE_SPELL_FUN(  spell_weaponsmith_curve  );
DECLARE_SPELL_FUN(  spell_weaponsmith_spellward  );
DECLARE_SPELL_FUN(  spell_weaponsmith_loyal  );
DECLARE_SPELL_FUN(  spell_weaponsmith_swordbane );
DECLARE_SPELL_FUN(  spell_weaponsmith_thirst  );
DECLARE_SPELL_FUN(  spell_weaponsmith_serpent  );
DECLARE_SPELL_FUN(  spell_weaponsmith_etherblade  );
DECLARE_SPELL_FUN(  spell_weaponsmith_etherguard  );
DECLARE_SPELL_FUN(  spell_weaponsmith_dragonslayer  );
DECLARE_SPELL_FUN(  spell_weaponsmith_ogreslayer  );
DECLARE_SPELL_FUN(  spell_weaponsmith_swordbreaker  );
DECLARE_SPELL_FUN(  spell_weaponsmith_serpentkiss  );
DECLARE_SPELL_FUN(  spell_weaponsmith_devour  );
DECLARE_SPELL_FUN(	spell_summon_golem	);
DECLARE_SPELL_FUN(	spell_conjurers_sword	);
DECLARE_SPELL_FUN(	spell_golem_plate	);
DECLARE_SPELL_FUN(	spell_golem_fists       );
DECLARE_SPELL_FUN(  spell_golem_cloak       );
DECLARE_SPELL_FUN(  spell_golem_shield      );
DECLARE_SPELL_FUN(  spell_golem_weapon      );
...
DECLARE_SPELL_FUN(	spell_enchant_treasure	);
DECLARE_SPELL_FUN(  spell_magika_armor		);
DECLARE_SPELL_FUN(  spell_channel			);
DECLARE_SPELL_FUN(  spell_ethereal_cloak	);
DECLARE_SPELL_FUN(  spell_mana_burn			);
DECLARE_SPELL_FUN(	spell_spirit_syphon		);
DECLARE_SPELL_FUN(	spell_disrupt_reality	);
DECLARE_SPELL_FUN(	spell_mute				);
DECLARE_SPELL_FUN(  spell_enhance_aura		);
DECLARE_SPELL_FUN(	spell_pierce_shadows	);
DECLARE_SPELL_FUN(	spell_enhance_armor		);
DECLARE_SPELL_FUN(	spell_enhance_weapon	);
DECLARE_SPELL_FUN(	spell_enhance_treasure	);
DECLARE_SPELL_FUN(	spell_venom_arrow		);
DECLARE_SPELL_FUN(	spell_barbed_arrow		);
DECLARE_SPELL_FUN(	spell_numbing_arrow		);
DECLARE_SPELL_FUN(	spell_summon_spirit		);
DECLARE_SPELL_FUN(	spell_alchemy_gold		);
DECLARE_SPELL_FUN(	spell_cloud_eyes		);
...
#define WEB_DIR		"../../../webman/public_html/pagefiles/" /* location for HoG web files -Darwin */

#define LUA_DIR         "../lua/"   /* Where Lua source files are kept */

#define AREA_LIST	"area.lst"	/* List of areas		*/
#define QUEST_FILE	SYSTEM_DIR "quest.dat" /* Storing Questmaster stuff */
...
#define HELP_FILE	SYSTEM_DIR "misshelp.txt" /* For misshing helps  */
...
#define SCOREGOLD_FILE  SYSTEM_DIR "scoregold.dat"  /* File to store the scores */
#define SCOREQP_FILE     SYSTEM_DIR "scoreqp.dat"  /* File to store the scores */
#define SCOREPK_FILE     SYSTEM_DIR "scorepk.dat"  /* File to store the scores */
#define SCOREMOBM_FILE     SYSTEM_DIR "scoremobm.dat"  /* File to store the scores */
#define SCOREMK_FILE    SYSTEM_DIR "scoremk.dat"  /* File to store the scores */
#define SCOREMP_FILE	SYSTEM_DIR "scoremp.dat"
#define SCORESP_FILE	SYSTEM_DIR "scoresp.dat"
#define SCOREXP_FILE	SYSTEM_DIR "scorexp.dat"
...
void calc_scoremobm         args( (CHAR_DATA *ch) );
void calc_scorepk           args( (CHAR_DATA *ch) );
void calc_scoreqp           args( (CHAR_DATA *ch) );
void calc_scoregold         args( (CHAR_DATA *ch) );
void calc_scoremk	    args( (CHAR_DATA *ch) );
void calc_scoremp		args( (CHAR_DATA *ch) );
void calc_scoresp		args( (CHAR_DATA *ch) );
void calc_scorexp		args( (CHAR_DATA *ch) );
/* acro.c */
void    remove_acro_player   args( (char *name) );
...
void	get_mflag	args( ( OBJ_DATA *obj, char *buf ) );
void    get_magvalue	args( ( OBJ_DATA *obj ) );
...
void	echo_to_all	args( ( sh_int AT_COLOR, char *argument,
				sh_int tar ) );
void    echo_to_area	args( ( sh_int AT_COLOR, CHAR_DATA *ch,
				char *argument ) );
...
void	affect_to_char	args( ( CHAR_DATA *caster, CHAR_DATA *ch, AFFECT_DATA *paf ) );
...
void	calc_mobmscore	args( ( CHAR_DATA *ch) );
void    calc_pkscore	args( ( CHAR_DATA *ch) );
void    calc_goldscore  args( ( CHAR_DATA *ch) );
void    calc_qpscore    args( ( CHAR_DATA *ch) );
...
char *	one_argument3	args( ( char *argument, char *arg_first ) );
...
int find_job	args( ( CHAR_DATA *ch, const char *name, bool know ) );
...
bool	saves_damage	args( ( int level, CHAR_DATA *victim ) );
...
bool    can_charm       args( ( CHAR_DATA *ch, int lvl ) ); 
...
void	tadvance_level	args( ( CHAR_DATA *ch ) );
...
char *  get_dual        args( (CHAR_DATA *ch) );
...
char *	get_position_string	args( ( CHAR_DATA *ch ) );
int taxed(int amount);
void tax(CHAR_DATA *ch, int amount);

typedef enum 
{ gather_oak = 0, gather_pine, gather_ash, gather_birch, gather_hawthorn,
  gather_yew, gather_walnut, gather_willow, gather_blackthorn, gather_elder
} gather_types;

#define MAX_GATHER gather_elder;

typedef enum
{ mine_coal = 0, mine_iron, mine_amethyst, mine_gold, mine_silver,
  mine_bloodstone, mine_diamond, mine_jade, mine_platinum, mine_titanium
} mine_types;

#define MAX_MINE mine_titanium;

void call_va( lua_State *L, const char *func, const char *sig, ...);
extern lua_State *L_mud;
#define SEQ(ch, x, y)    (IS_NPC((ch)) ? save_mob_equipment[(x)][(y)] : save_equipment[(x)][(y)])

#define SET_SEQ(ch, x, y, val)                              \
do                                                          \
{                                                           \
    if(IS_NPC(ch))                                          \
        save_mob_equipment[(x)][(y)] = val;                 \
    else                                                    \
        save_equipment[(x)][(y)] = val;                     \
}while(0)
