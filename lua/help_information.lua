all_helps.information = {}
all_helps.information = {
  entries = {
  {
    keywords = {"info", "information", "general information", "general info", "general help", "general helps", "informational"},
    htype = "catagory",
    level = -1,
    text = function ()
     send("&WHelp files catagorized as 'information'&D")
     send_nocr("&Y")
     hyphens()
     txt = "&W" .. get_catagory_list ("info") .. "&Y"
     send(txt)
   end,
  },
  {
    keywords = {"command", "commands", "command helps"},
    htype = "catagory",
    level = -1,
    text = function ()
     send("&WHelp files catagorized as 'command'&D")
     send_nocr("&Y")
     hyphens()
     txt = "&W" .. get_catagory_list ("command") .. "&Y"
     send(txt)
   end,
  },
  {
    keywords = {"rule", "rules", "mud laws", "mud law"},
    htype = "catagory",
    level = -1,
    text = function ()
     send("&WHelp files catagorized as 'rule' or 'law'&D")
     send_nocr("&Y")
     hyphens()
     txt = "&W" .. get_catagory_list ("rule") .. "&Y"
     send(txt)
   end,
  },
  {  
...
Ahpock...... devoid of magical abilities, they are the epitome of soldiers
  ...
  {
    keywords = {"race", "races", "race helps", "races help"},
    htype = "catagory",
    level = -1,
    text = function ()
     send("&WHelp files catagorized as 'race'&D")
     send_nocr("&Y")
     hyphens()
     txt = "&W" .. get_catagory_list ("race") .. "&Y"
     send(txt)
     send_nocr("&Y")
     hyphens()
     send([[
&WThere are currently 23 known races existing within these Realms.
Type "help [race]" for specific information on the specified race.
  ...
  {
    keywords = {"wizhelp", "wizhelps", "wizcommand", "wizcommands", "imm helps", "immhelps"},
    htype = "catagory",
    level = -1,
    text = function ()
     send("&WHelp files catagorized as 'wizhelp'&D")
     send_nocr("&Y")
     hyphens()
     txt = "&W" .. get_catagory_list ("wizhelp") .. "&Y"
     send(txt)
   end,
  },
  {
    keywords = {"class", "classes", "class helps"},
    htype = "catagory",
    level = -1,
    text = function ()
     send("&WHelp files catagorized as 'class'&D")
     send_nocr("&Y")
     hyphens()
     txt = "&W" .. get_catagory_list ("class") .. "&Y"
     send(txt)
   end,
  },
  {  
...
.
  ...
  {  
    ...
    htype = "info",
    text = [[
Your alignment can be good, neutral or evil.  You can change your alignment by
talking to the old sage in Elenolos, or by joining a following of the various
Demigods.  You alignment will never change in any other way.
...
You can extra experience points for fighting mobs that are opposite your
alignment.  Good characters lose a small amount of experience when fighting
good mobs.

New characters start out as neutral.  You can find out what your alignment is
by typing SCORE.
]],
  },
  {  
...
The House of Ghouls will provide a copy of areas built by individuals
...
on other muds, you must contact that individual.
  ...
  {  
    keywords = {"ARMOR CLASS", "ARMORCLASS"},
    level = 1,
    htype = "info",
    text = [[
Your armor class is a rating depicting how protected you are from physical
blows in combat.  The lower your armor class, the better.  When inspecting
pieces of armor,  having a high positive number in the  "Armor class is #"
part is good.  Having a high negative number in the "Affects armor class by #"
is good.  Some armor provides more protection than others, depending on its
type and placement on your body.
]],
  },
  {  
    keywords = {"LEGENDARY"},
    ...
    htype = "info",
    text = [[
Many heroes wander the lands about you.  Over the course of time, many have
specialized certain skills or spells, useful to gain the edge over other
mighty foes.  The price in glory is steep, with each hero requiring the
apprentice to spread his name to the far reaches of the land.  But a hero who
has the patience and drive to learn from these ancient masters wields
tremendous power, and deserves the highest of respects.

See also: 'ASTRAL RIFT', BLADESONG, BLOODSONG, CONCENTRATE, STARCLOAK,
WILLPOWER, WINDWALK
]],
  },
  {  
...
fireball may injure themselves when the spell backfires.
  ...
  {  
    keywords = {"BETWEEN BLADES OF GRASS", "BLADES GRASS"},
    level = 1,
    htype = "info",
    text = [[
Reports of a magical standing stone just south and west of Alden have
intrigued travelers for many an age.  Noone is quite sure, however, what
actually goes on around it.  The sounds of bees is usually thick in the
summertime, however.
]],
  },
  {  
...
over channels, or make your way to a healer, who will eventually remove your
blindness.  Certain spells may let you see even when blind!
...
Check DAMAGE for information about damage levels.
]],
  },
  {  
    keywords = {"SOCIALS"},
...
(Special thanks to KaVir for quite a few of the socials)
...
See also EMOTE
  ...
  {  
    ...
    htype = "info",
    text = [[
Concerns and complaints may be emailed to Darwin (xdarwinevolved@aim.com).
Details are VERY important.
  ...
  {  
    ...
    htype = "info",
    text = [[
Some spells require certain magical components.  Examples are the alchemy
spells used by shamans and all the spells used by conjurers.  Some of the more
common components can be bought from magic shops, but the more rare ones must
be found.  Due to the magical nature of spell components, the locate spell
...
See &WHELP REIMBURSEMENT &w and &WHELP SAVE &w
 ...
 | of House of Ghouls, as without them this mud could not be what it is.   |
 | Thanks to anyone I've forgotten to credit for any code I've "borrowed"  |
 | Thanks to all those other creative minds who wrote some interesting     |
 | things  (:                                                              |
 | o                             -Drazuk                                 o |
 ---------------------------------------------------------------------------
]],
...
The message shown will reflects a specific fixed amount.

For a list of damage verbs in order of damage, check DAMVERBS.
]],
  },
  {  
    keywords = {"DAMROLL"},
...
The higher the number, the better.
  ...
  {  
    ...
    htype = "info",
    text = [[
The damage verbs vary for different weapon types.  Here are the lists, in
order from strongest to weakest.

Blades             Bludgeons         Others
---------------    --------------    -----------------
miss               miss              miss
barely scratch     barely scruff     brush
...
_shred_            _punish_          _assail_
_butcher_          _cripple_         MUTILATE
DISEMBOWEL         MUTILATE          MASSACRE
DISFIGURE          DISFIGURE         PULVERIZE
GUT                MASSACRE          DESTROY
DISSECT            CLOBBER           WRACK
EVISCERATE         PULVERIZE         *OBLITERATE*
*SLAUGHTER*        *OBLITERATE*      **ANNIHILATE**
**ANNIHILATE**     **ANNIHILATE**    ***SMITE***
***AMPUTATE***     ***DISABLES***    ***ERADICATE***
]],
  },
  {  
    keywords = {"DEATH"},
    ...
    htype = "info",
    text = [[
When your character dies, you are reincarnated at the Temple of Drazuk in
Alden.  Your corpse is left behind where you were killed, together with
all of your equipment and gold.
...
will be scattered in the room your corpse was in. After a period of time
these items will decay as well. Player corpses last roughly 30 minutes of
real time. Anyone can loot a corpse.
...
By these acknowledgments you hereby save and exempt this MUD and its
Administrators from any and all liability that may arise during gameplay.
]],
  },
  {  
    keywords = {"DISCLAIMER2"},
    level = 1,
    htype = "info",
    text = [[
OUR WAY OR THE HIGHWAY
  ...
  {  
    ...
    htype = "info",
    text = [[
The main town of the House of Ghouls, Alden is a full service city.  You
can find multiple shops to buy many different goods.  There is also a
Questmaster to be found here, and a Healer is located in the Temple of Drazuk.
If you are in the need of equipment, check the Donation Pit in the
Temple...perhaps Jerald has something for you there.  All roads in the Realm
lead to Alden at some point.
]],
  },
  {  
    keywords = {"DUAL", "DUAL CLASS", "DUAL-CLASS"},
    level = 1,
    htype = "info",
    text = [[
Dual-class characters are characters that share the skills and spells
of two different classes at one time.  While this gives the player
a lot more potential power, the experience bases of both classes are
added together, making it a lot harder to level.  Also, if one class
has a penalty, it will apply to the character.  For instance, a
warrior-mage cannot wear metal equipment (mage penalty).

Dual-classing is a fun challenge, and worth a try.
]],
  },
  {  
...
/ s              Save buffer, and exit the editor.
  ...
  {  
    keywords = {"ELDER FOREST"},
    level = 1,
    htype = "info",
    text = [[
The Elder Forest has tree's that have been growing since the birth of the
Realm.  The main road is quite safe, for the magic of the forest protects
travellers from bandits and other creatures.  Travelling off of the beaten
path is quite dangerous however, for the protective magic blocks many avenues
of escape.  Multiple paths lead to the lairs of various creatures, some more
friendly than others.  It is rumored that the bandits that plague the Realm
have taken up residence here, and sightings of a large dragon flying overhead
...
Each class has a set base level of experience needed to reach each level.
Check the help file for your class to see how much that base is.  If you
are dualclassed, you need the base experience of your main class plus
70% of the base experience of your dual class to level.  This is calculated
using the lowest experience base between the two, no matter which was
picked first.

You also get a bit of experience for using skills in combat, for hitting
a mob in combat, and for using a damage-causing spell in combat.  The higher
the level of skill, the more experience you get, and the more damage you
do, the more experience you get.  You will not be notified of experience
gained in these ways, but you will get it.
]],
  },
  {  
    keywords = {"FLAG", "FLAGS"},
    ...
    htype = "info",
    text = [[
&P(BULLY)&W, &P(KILLER) &Wand &P(THIEF) &Wflags are given to players who
violate laws regarding Pkilling. Having one of these flags
will cause mobs to treat you differently. For help on &P(BULLY) &Wor
&P(KILLER) &Wflags, see &CHELP BULLY &Wor &CHELP KILLER&W.

Thief flags however, are removable after time, by certain mobs who might be
inclined to take bribes...and its not cheap.
]],
  },
  {  
    keywords = {"FOLLOWINGS", "FOLLOWING"},
    level = 1,
    htype = "info",
    text = [[
Adventurers can choose to join various followings, headed by Demigods of the
House of Ghouls.  For more info about followings, use FINFO or ask members of
the followings.
]],
  },
  {  
...
on quest items at the Questmaster.
...
like Odysseus passing all the renown for his deeds off onto someone else.

See also: GLORY RATES,  GLORY TRADE
]],
  },
  {  
    keywords = {"GLORY TRADE"},
    level = 0,
    htype = "info",
    text = [[
...
See also GLORY
  ...
  {  
    ...
    htype = "info",
    text = [[
For a complete list of immortals use the WIZLIST command.
]],
  },
  {  
    keywords = {"GREENPATH"},
    ...
    htype = "info",
    text = [[
Headed out of the gleaming white gates of the west entrance to
Alden, the Greenpath is a delightful road through rolling green
hills.  Lengths of forest can be seen to the north, but the south is
filled with the rounded tops of hills, as far as the eye can see.

Ending far to the west at Elenolos, the hometown of the elves, this
once very safe road may not be safe all that longer.  Reports of orc
raiders have been circulating the taverns, and reports that the elves
may not be sitting idle either.  Caution is advised when travelling.
]],
  },
  {  
    keywords = {"GROUP DISPLAY"},
    level = -1,
    htype = "info",
    text = [[
&g
Following Zed           [class] [-race-] [hit] [mag] [mvs] [mst] [--level--]
[&G35  (&R-&G)&g] &GZed              Mage    Ghoul &w 100% &C 100% &w 100% &G ===
&gEach line begin with the [&wLevel Alignment&g] for each char.
Alignment reads:
   &G(&R-&G)&g Evil
   &G(&zo&G)&g Neutral
   &G(&B+&G)&g Good

&w[class]&g   lists the primary class for each character.
&w[-race-]&g  lists the race for each character.
&w[hit]&g     lists current hitpoints for each character:
...
&w[mag]&g lists current mana for each character.
          Warrior mana is not displayed.
...
&w[--level--]&g displays exp required to attain the next level (non-Avatars
only)
]],
  },
  {  
...
10 of your Adventurer's Guide for more information on groups and grouping.
  ...
  {  
    ...
    htype = "info",
    text = [[
All players get a copy of The Adventurer's Guide to the House of Ghouls
...
to our House.
  ...
  {  
    keywords = {"HAUNTED CHURCH"},
    level = 1,
    htype = "info",
    text = [[
Located at the far end of the Elder Forest, an old church lays abandoned by
its previous occupants.  Travellers report that vermin have taken up residence
in the ruins, and strange noises and lights have been heard and seen at night.
 A few stories mention that the Ghouls enter the world from this location, but
so far, no proof has been acquired of their existence.  Religious folk swear
great evil emanates from this place.
]],
  },
  {  
    keywords = {"HELP"},
...
To find help topics available to you, type &YHELP CATAGORIES&W. This will give
you a short list of help file catagories. Every help entry is catagorized into
one of those keywords.
]],
	see_also = {"CATAGORIES", "LUA HELP FILE SYSTEM"},
  },
  {  
    keywords = {"HITROLL", "HR"},
    level = 1,
...
Note - The list of help files is quite extensive, and the command does
  ...
  {  
    ...
    htype = "info",
    text = [[
We have a hotboot system here at HoG which means we can reboot the MUD while
you are playing, often without any notice at all (except the message about
ethereal smoke popping up!).

Immortals, above level 54, you have this ability.  Use it wisely.  It can fix
most problems (so far used to clear the weird names that pop up in place of
mob, object or room names), but can also cause a few strange thing.  It will
break any quest a player is on as if they quit, so use "QSTAT" to check and
see who is questing, or just ask on gossip.  You also can't hotboot if
anyone is fighting, so might need to ask players to chill for a second if this
becomes necessary.

Also clean up any player corpses before doing this.  We've seen some strange
duplication of items when hotbooting soon after a player death.
]],
  },
  {  
    keywords = {"HP"},
...
at creation and gain more hp per gained level, depending on
class, race and CON.  Equipment can also add to your total hp.
]],
  },
  {  
    keywords = {"INFORMATION2"},
    level = 1,
    htype = "info",
    text = [[
...
TIME    - This will tell you the current times inside the Realms, the time
          the Realms was last rebooted, and the current system time.
...
Tickler in Alden that a tribe of kobolds had taken up residence in an
...
without resorting to public baiting and name-calling.
  ...
  {  
    ...
    htype = "rule",
    text = [[
&GDo not bring aggressive mobs into or near Alden, as when their charm
...
If you buy a house (see the Deed agent in Alden), you have the option of
...
NEWBIESET puts the default (i.e. Alden University) equipment into the
...
Drazuk in Alden; should you one day become a member of a
...
heavy debris at you!
  ...
  {  
    ...
    htype = "info",
    text = [[
You can buy pets in the pet shop. 

Using the ORDER command, you may command your pet to do many things. There
are some commands that will cause your pet to act confused if it cannot
perform the command. You are responsible for the actions of your pets.

Your pets will gain experience points and level just as you do, but only if
they are engaged in combat. Pets are allowed to wear equipment designated
for pets or animals. 
]],
    see_also = {"PETSAVE", "RESURRECT"},
  },
  {  
    keywords = {"PETSAVE"},
    level = 1,
    htype = "info",
    text = [[
Petsaving is automatic. When you purchase a pet, it is loyal to you until its
death. Your pet will automatically save when you save and quit when you quit.
If you die, your pet may still live and vice-versa.

Pets remain loyal until they die. If you lose link your pet may be killed 
without you around to protect it.

Your pet may be resurrected if it dies. You must have your pet's corpse with
you and go to a pet store to have the pet resurrected. You may only resurrect
your own pet.

In no instances will pets be reimbursed. Do not even ask.
]],
    see_also = {"PETS", "RESURRECT"},
  },
  {  
    keywords = {"PFILES"},
    level = 65,
...
Tokens for % are:
  ...
  %t  - displays the hour of the day     %p  - displays your position
  %G  - displays your bank balance
  %b  - displays the room name           %B  - displays current exits
...
Drazuk in Alden.  When you re-enter the game you will be back in the
...
Scrolls of recall are available in Alden's section of magic shoppes.
]],
...
not be used while in combat.]],
  ...
  {  
    ...
    htype = "info",
    text = [[
Heading south out of Alden is a well-built road that travels all the way
...
Southern Road, from the south ports to Alden.
]],
  },
  {  
...
Think is an immortal channel.
  ...
  {  
    ...
    htype = "info",
    text = [[
Dwarves from the Ironkore mountains east of Alden forged their way down
...
NOTE:  It could be quite dangerous to unfold an area that is already
  ...
  {  
    keywords = {"UNIVERSITY OF Alden", "UNIVERSITY"},
    level = 1,
    htype = "info",
    text = [[
The University of Alden is a great place to learn about how the world
...
WHO shows the characters currently logged in. Immortals who are wizinvis higher
than your own level will not appear unless you have been grantsighted.
]],
  },
  {  
    keywords = {"WHO LEADER"},
...
non-prototype zone in the mud.
  ...
  },
  {
    ...
    htype = "info",
    text = [[
Darwin is the current code implementor at House of Ghouls. If you should
happen to come across a bug or have an idea for future implementation, you
can post a note to Darwin at Kallista or email him at xdarwinevolved@aim.com.
The best way, however, to get Darwin's attention is to post a message on the
House of Ghouls forms at: &Chttp://houseofghouls.proboards101.com/index.cgi&D
]],
  },
  {
    keywords = {"fcharmie"},    
    ...
    htype = "wizhelp",
    text = [[
Syntax: fcharmie <master> <charmie> <duration>

This will set <charmie> as <master>'s charmie as if they cast the spell. The
spell will last for <duration> rounds. None of the parameters are optional.
]],
  },
  {
    keywords = {"reconomy"},    
...
This will reset all area economies that are above 250,000,000 back to the
starting value of 250,000,000. This is to be used only in extreme cases where
several reboots, hotboots and/or crashes have caused a major increase in
economy values due to interest being calculated upon startup.
]],
  },
  {
    keywords = {"stoke"},    
    ...
    htype = "command",
    text = [[
Syntax: stoke <combustable>

This command allows a player to add more combustables to a fire to increase
the fire's temperature. The fire has a maximum temperature of 6000 degrees.
]],
  },
  {
    keywords = {"quest equipment", "quest eq", "questeq"},    
    level = 1,    
    htype = "info",
    text = [[
Quest equipment is special equipment that can be bought using glory points.
These items have a special flag that allows only one owner to use them and
no one else. When a player dies, these items are transported back to the
player.
]],
  },
  {
    ...
    htype = "wizhelp",
    text = [[
Syntax: setrandom <object>

This command is used to mark an item as random so that it can be fstored in
a following pit or donated to the donation pit. It is to be used sparingly.
The item being marked as random must be in your inventory.

Idealy this is to be used only for clan chests that do not have the random
flag already on them.
]],
  },
  {
    keywords = {"personal lockers", "personal locker"},    
    level = 1,    
    htype = "command",
    text = [[
Syntax: locker buy
...
A personal locker is a special locker you can purchase with 5000 glory points.
You can take this locker with you anywhere. This locker has a capacity of
100kg when you first purchase it. You can increase its capacity up to 1000kg
by purchasing additional storage space, 100kg at a time. This locker is with
you always, unless taken from you by an immortal. It will allow you to store
any items you want inside it and access them from anywhere. There are some
restrictions to this. You will not be able to get or put any items in your
locker while you are in combat or shortly after combat with another player.

Locker commands -
locker buy: Spend 5000 glory to obtain a new 100kg personal locker or increase
  your existing locker by 100kg.
locker open: Used to check your locker's contents.
locker get <item>: Used to get an item from your locker.
locker put <item>: Used to put an item inside your locker.
locker check: This will tell you how much weight your locker contains and what
  ...
  },
  {
    ...
    htype = "wizhelp",
    text = [[
When using 'sset <sn> affect stripsn' you can now use the spell name instead
of using the spell's sn.
ex: sset 433 affect stripsn 'blindness'

To apply an affect to caster only or caster and victim, place an excaimation
mark before the affect to be placed on the caster.
ex: sset 433 affect !strength 5 l*5
This will add +5 strength to the caster for level*5 rnds and any additional
affects will be applied to the spell's target.

Another affect that can be added is the 'jump' affect. This affect will cause
the caster to be removed from combat.
ex: sset 455 affect jump

To create a stun effect use the 'wait' affect. Supply a number in a multiple
of 10 per each second of stun you want to apply.
For instance, to apply 5 seconds of stun you would use:
sset 455 affect wait 0 50
]],
  },
  {
    keywords = {"verbal", "non-verbal", "nonverbal"},    
    level = 1,    
    htype = "info",
    text = [[
There are two different types of spells when it comes to casting them. There
are verbal and non-verbal types. The verbal types must be uttered when cast.
If the caster cannot utter the spell, then it cannot be cast. Non-verbal
spells, on the other hand, can be cast without uttering a word. This is
usually done by memorizing a series of hand movements. The non-verbal spell
may also be cast with the simple use of the caster's breath.
]],
  },
  {
    keywords = {"conjurers equipment"},    
    level = 1,    
    htype = "info",
    text = [[
&WIf the conjurer is the victim of a &RPK&W, all the conjurer enchanted items
will start to rot. If they are &RNOT&W held in the &Yimmediate inventory &w
(ie: if you type 'inventory' and do not see the items, they are not in your
immediate inventory)&W of a player within &R5&W minutes, the enchanted items
will totally decay and be destroyed. If the items are being held in a player's
inventory, they become owned by that player. The conjurer-only flag fades away
and the items become inventory. This means that upon the next death of that
player &w(death by mob or by PK)&W, the items are destroyed.

This has no effect if the conjurer was killed by a mob.&D
]],
  },
  {
    keywords = {"oget"},    
...
Oget will retrieve any item in the realm using its id number or vnum. If the
vnum is used, it will retrieve the first item it comes across that matches the
specified vnum. Using the id number is more precise and will retrieve the
exact object requested.
]],
  },
  {
    keywords = {"eqswapping", "equipment swapping"},    
    level = 1,    
    htype = "info",
    text = [[
At no time can a player transfer gold or equipment of ANY sort (this includes,
but is not limited to, quest, stock, and randoms) to any character played by
or owned by the "donator". This further includes an immortal facilitated
destroy. Even a character of the same name and same history is still a
different entity and therefore cannot profit or retain anything from the
previous incarnation. Special consideration will be given to extenuating
circumstances and can only be authorized by an Implementor.
]],
  },
  {
    keywords = {"abbaffs"},    
    ...
    htype = "info",
    text = [[
&WWith this setting turned on (config +abbaffs) you will see a combined
abbreviated affects list. For example, if normally you would see this:
&P(&WSanct&P) (&RFS&P) (&BSS&P) (&CIS&P) (&CInvis&P) (&BHide&P) (&WTranslucent&P)&W
With ABBAFFS on, you would see this:
&P( &WS &RF &BK &CI &WV &BH &YT &P)&W
...
Letter abbreviations:
  ...
  &BK&W - Shockshield
  &CI&W - Iceshield
  &WV&W - Invis/Improved invis/Mass invis
  &BH&W - Hide
  &GC&W - Camo
  &YT&W - Pass door (Translucent)
  &PP&W - Faerie fire/Faerie fog (Pink aura)
]],
  },
  {
    keywords = {"convert"},    
...
&WThis command allows a &Ctiered&W character to set their dualclass to a new
class by allowing you to choose a class from your available pre-tier classes.
(If you are an archmagi, you may choose to 'convert mage' 'convert druid' or
'convert conjurer' etc.)

If your 'whois' lists you as only &CArchmagi&W, &CBishop&W, &CChampion&W or
&CRogue&W you will need to use this command and choose a class. If you do not
choose a class, you will see a message asking you to choose one.

For &Cnon-tiered&D characters, this command will remove any skills that have
been removed from your class(es) or skills that you have obtained through
other means.&D
]],
  },
  {
    ...
    htype = "race",
    text = [[
The Shuri have long lived in seclusion in the southern continent, preferring
to be alone rather than deal with the minotaur or wolfen. Naturally athletic
with amazing balance and dexterity, the Shuri have survived by their natural
prowess as hunters but also their deep attunement to the natural. Due to their
life among the trees, lounging in the sun or stalking prey, the Shuri can
naturally hide. Their thick fur makes them resistant to basic attacks but they
are severely fearful and suspectible to electricity.

Shuri get 95% of the normal experience award.

Shuri can be a Warrior, Thug, Thief, Ranger, Monk, Druid or Shaman.
]],
  },
  {
    keywords = {"gulran"},    
    ...
    htype = "race",
    text = [[
The Gulran have made their home in the high mountains, long since battling
dwarves, orcs, drow, and kobols for the right to control the Ironkores. Gulran
are massive creatures, with the most gigantic strength and constitution to
match. However, their large size limits their dexterity a great deal. Gulran
are quite dull, being of lowered intelligence and wisdom, but they make up for
this with their great strength. They are naturally weak to magic and energy,
but are very resistant to physical attacks.

Gulrans get 90% of the normal experience award.

Gulrans can be a Warrior, Ranger, Thug, Druid, Shaman or Diabolist.
]],
  },
  {
    keywords = {"zephyr"},    
    ...
    htype = "race",
    text = [[
The Zephyr have lived high in the mountains or forest tops, far away from the
giants or Shuri. The Zephyr, being avian in origin, are naturally able to fly.
The Zephyr are incredibly swift, intelligence, and wise. Yet to sustain flight
they are quite fragile with limited strength and endurance. The Zephyr are
quite well protected against lightning and draining energies but are very weak
against crushing weapons as their bones are hollow.

Zephyrs get 100% of the normal experience award.

Zephyrs can be a Warrior, Ranger, Monk, Thief, Mage, Conjurer, Cleric or
Shaman.
]],
  },
  {
    ...
    htype = "race",
    text = [[
The Jinn are ancient creatures of pure magic. They have very little substance
to them, made of mostly energy and air. Often used as slaves by the more
magically inclined races, the Jinn have recently broken free and moved out
into the world. The Jinn are by far the most intelligent and wise of any
mortal being and are unrivaled magic users. However, they have little physical
abilities with no strength or constitution to speak of. They are very weak to
all forms of physical damage but are quite resistant to any form of magic.

Jinns get 110% of the normal experience award.

Jinns can be a Mage, Druid, Shaman, Diabolist, Cleric or Conjurer.
]],
  },
  {
    keywords = {"ahpock"},    
    ...
    htype = "race",
    text = [[
The Ahpock, recently freed from their captivity by the Elder Spawn, have moved
out into the world to find their place. The Ahpock are the epitome of
soldiers, trained from birth by the spawn to be the greatest fighters. Despite
their normal size, the Ahpock are incredibly strength, endurant, and quick.
However, the spawn used selective breeding to ensure they were dimwitted,
foolish, unlucky, and crude. The Ahpock are weak to magic in all aspects, a
tool of control by the spawn, but are completely resistant to any physical
attack.

Ahphocks get 110% of the normal experience award.

Ahpocks can be a Warrior, Monk, Ranger, Thief or Thug.
]],
  },
  {
    keywords = {"task"},    
...
task list         - Lists the current tasks you have accepted.
task available    - Lists the tasks currently available to you in your
                    current room.
task show [id]    - Shows the details of a task with the given id.
task accept [id]  - Accept the task with given id.
task finish [id]  - Finalize the task. This is how you will recieve you
                    rewards for finishing the task.
task abandon [id] - Abandons a task. The task becomes available to you
                    to accept again later.
task history      - Displays a list of all tasks you have finished.
]],
    see_also = {"task system"},
  },
  {
    keywords = {"whereis"},    
    level = 1,   
...
Whereis by itself will give you a list of available destinations, if they
exist for the area you are in.

By specifying a location, one given in the list of available destinations,
you will be given a set of directions from your current location to the
location you specified.
]],
  },
  {
    keywords = {"Lua help file system"},
    level = 1,
    htype = "info",
    text = function ()
     send([[
&WThe Lua help file system allows for a bit of flexibility when creating the
text for any entry in the system. For instance, it can make a help entry look
personalized by inserting the character's name into it such as:

]])
     send(fix_description("&YHello, &C$n&Y. It is a pleasure to have you playing here with us."))
     send([[

&WIt can also allow for automatically generated text for the help file such as 
that when you look at HELP SKILLS or HELP INFO. The text from those help files
is generated by a function call instead of hand written. This is sure to help 
in locating those odd or hard-to-remember help files.

Other things about this system include the headers to help files. These appear 
at the top of the help file surrounded by a row of dashes. The word in the middle 
of this header indicates the catagory this help entry is filed under.

There may also be a "See also" footer attached to the help file. This will 
appear at the bottom of the help file below a row of dashes. It will list 
individual help entries in yellow separated by a grey comma.

The help system is not case sensitive and does not require the use of single 
quotes around multiple words, so please avoid using quotes.
]])    
    end,
    see_also = {"catagories"},
  },
  {
    keywords = {"catagory", "catagories"},
    level = -1,
    htype = "info",
    text = function ()
     send([[
&WThe following are catagories that you can use in order to locate help files
associated with that catagory.
]])
     send_nocr("&Y")
     hyphens()
     txt = "&W" .. get_catagory_list ("catagory") .. "&Y"
     send(txt)
     send_nocr("&Y")
     hyphens()
     send([[
&WUse these as you would any other help file. Example: help skill
This will list all help files about skills.
]])
     end,
   },
   {
     keywords = {"Task system"},
     level = 1,
     htype = "info",
     text = [[
&WThe task system is a continually growing questing system. It requires a lot
of thought to be put into each task as they require a bit of a story or reason
to go with it. As such, we welcome any ideas for new tasks. Here is a list of
items for each task:

    &Yid&W:             This is the identification name used to access this task.
    &Yname&W:           This is what will show up in the [INFO] message when the 
                    task is finished.
    &Ydescription&W:    This is what is shown when you input "task show [id]"
    &Ygiver&W:          This is the (vnum) mob that will give the task.
    &Yreceiver&W:       This is the (vnum) mob that will complete the task. It is not
                    required. If not supplied then the giver is also the
                    receiver.
    &Ymin_level&W:      Not required, will default to 1 if not supplied. This is the
                    minimum level allowed to attempt this task.
    &Ymax_level&W:      Not required, will default to 50 if not supplied. This is the
                    maximum level allowed to attempt this task.
    &Yavailable&W:      This is a function that will return true or false depending on
                    if certain criteria are met. This is a good place to put
                    prerequisite tasks, skills, items, etc...
    &Yaccept&W:         This is a function that execute once a player has accepted the
                    task. This is a good place to add story info such as the giver
                    explaining the task and why it needs to be completed.
    &Ycomplete&W:       This is a function that is called when a player completes the
                    task. This is a good place to finish up the story and reward
                    the player. It can also be used to cleanup anything left over
                    from the task such as collected items or generated mobs.
    &Yabandon&W:        This is a function that is called when a player abandons the
                    task. This is another good place to put things in to cleanup
                    anything that may be left over from the task. You can also supply
                    additional story to the player.
    &Ytime_limit&W:     This is a time limit, in minutes, of how long the player has to
                    finish the task.
    &Ysubtasks&W:       This is a collection of tasks that are required to be completed
                    before this task can be finished.
]],
    see_also = {"task system subtask fields"},
  },
  {
    keywords = {"task system subtask fields"},
    htype = "info",
    level = 1,
    text = [[    
    &Csubtask fields&W:
    
    description:    A very brief description of what this task is. Keep short to about
                    50 characters or less.
    type:           One of the subtask types below:
                    * &Ykillmob&W   - must kill '&Ycount&W' mobs in vnums table
                    * &Yvisitroom&W - must visit one of the rooms in the vnums table
                    * &Ybribe&W     - must bribe one of the mobs in the vnums table
                                  '&Ycount&W' coins
                    * &Ygive&W      - must give '&Ycount&W' objects of vnum '&Yitem&W'
                                  to one of the mobs in the vnums table
                    * &Yget&W       - must get '&Ycount&W' objects of vnum '&Yitem&W'
                                  (into inventory)
                    * &Ybuy&W       - must buy '&Ycount&W' objects of vnum '&Yitem&W' 
                    * &Ywear&W      - must wear '&Ycount&W' objects of vnum '&Yitem&W' 
                    * &Ydrop&W      - must drop '&Ycount&W' objects of vnum '&Yitem&W' 
                    * &Yrepair&W    - must repair '&Ycount&W' objects of vnum '&Yitem&W' 
                    * &Yuse&W       - must use '&Ycount&W' objects of vnum '&Yitem&W'
                    * &Ypossess&W   - must have '&Ycount&W' objects of vnum '&Yitem&W' 
                                  in inventory
             
     &Ycount&W:         The number of items to get/buy/drop etc., count of mobs to 
                    kill, size of bribe. If omitted, defaults to 1.
     &Yvnums&W:         A table (collection) of vnums of mobs.
     &Yitem&W:          The vnum of item to get/buy/drop etc. (required, where applicable)
     &Ycomplete&W:      This function is called when this subtask is completed
                    If omitted, nothing special is done. This is also a good
                    place to cleanup things from completed subtasks.
                
     &RNote&Y: 'get' counts when you obtain the item, even if you subsequently 
           lose it.
           'possess' counts possession of the item, giving it away before 
           handing in will fail the subtask. "Possess" items are destroyed 
           on task completion.
]],
    see_also = {"Task system"},
   },
